...
Self CommandBuffer::cmdBeginRendering(const VkOffset2D offset,
    ...
    vkCmdBeginRendering(__handle, &info);
    return *this;
}
#endif
...
CommandBuffer::Self CommandBuffer::cmdBlitImage(const Arg<Image>& src,
    ...
    vkCmdBlitImage(__handle, src, src_layout, dst, dst_layout, 1, &blit, filter);
    return *this;
}
...
CommandBuffer::Self CommandBuffer::cmdCopyImage(const Arg<Image>& src,
    ...
    vkCmdCopyImage(__handle, src, src_layout, dst, dst_layout, 1, &copy);
    return *this;
}
...
CommandBuffer::Self CommandBuffer::cmdCopyBuffer(const Buffer& src,
    ...
    copy.size = size;
    vkCmdCopyBuffer(__handle, src, dst, 1, &copy);
    return *this;
}
...
CommandBuffer::Self CommandBuffer::cmdCopyImageToBuffer(const Arg<Image>& img,
    ...
    vkCmdCopyImageToBuffer(__handle, img, img_layout, buf, 1, &copy);
    return *this;
};
