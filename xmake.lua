...
add_requires(
	"imgui v1.92.7",
	{ configs = { glfw = true, vulkan = true, cxflags = "-DIMGUI_IMPL_VULKAN_NO_PROTOTYPES" } }
)
...
target("vktor", function()
	...
	add_packages("vulkan-headers", "volk", "glslang", "vulkan-memory-allocator", "glm", "fmt", { public = true })
