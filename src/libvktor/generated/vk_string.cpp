...
String On_Str_VkResult(VkResult e) {
    ...
    case VK_ERROR_NOT_PERMITTED: str = "VK_ERROR_NOT_PERMITTED"; break;
...
String On_Str_VkStructureType(VkStructureType e) {
    ...
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VULKAN_1_4_FEATURES: str = "PHYSICAL_DEVICE_VULKAN_1_4_FEATURES"; break;
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VULKAN_1_4_PROPERTIES: str = "PHYSICAL_DEVICE_VULKAN_1_4_PROPERTIES"; break;
    case VK_STRUCTURE_TYPE_DEVICE_QUEUE_GLOBAL_PRIORITY_CREATE_INFO: str = "DEVICE_QUEUE_GLOBAL_PRIORITY_CREATE_INFO"; break;
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_GLOBAL_PRIORITY_QUERY_FEATURES:
        str = "PHYSICAL_DEVICE_GLOBAL_PRIORITY_QUERY_FEATURES";
        break;
    case VK_STRUCTURE_TYPE_QUEUE_FAMILY_GLOBAL_PRIORITY_PROPERTIES: str = "QUEUE_FAMILY_GLOBAL_PRIORITY_PROPERTIES"; break;
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_SUBGROUP_ROTATE_FEATURES:
        str = "PHYSICAL_DEVICE_SHADER_SUBGROUP_ROTATE_FEATURES";
        break;
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_FLOAT_CONTROLS_2_FEATURES:
        str = "PHYSICAL_DEVICE_SHADER_FLOAT_CONTROLS_2_FEATURES";
        break;
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_EXPECT_ASSUME_FEATURES:
        str = "PHYSICAL_DEVICE_SHADER_EXPECT_ASSUME_FEATURES";
        break;
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_LINE_RASTERIZATION_FEATURES:
        str = "PHYSICAL_DEVICE_LINE_RASTERIZATION_FEATURES";
        break;
    case VK_STRUCTURE_TYPE_PIPELINE_RASTERIZATION_LINE_STATE_CREATE_INFO:
        str = "PIPELINE_RASTERIZATION_LINE_STATE_CREATE_INFO";
        break;
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_LINE_RASTERIZATION_PROPERTIES:
        str = "PHYSICAL_DEVICE_LINE_RASTERIZATION_PROPERTIES";
        break;
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VERTEX_ATTRIBUTE_DIVISOR_PROPERTIES:
        str = "PHYSICAL_DEVICE_VERTEX_ATTRIBUTE_DIVISOR_PROPERTIES";
        break;
    case VK_STRUCTURE_TYPE_PIPELINE_VERTEX_INPUT_DIVISOR_STATE_CREATE_INFO:
        str = "PIPELINE_VERTEX_INPUT_DIVISOR_STATE_CREATE_INFO";
        break;
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VERTEX_ATTRIBUTE_DIVISOR_FEATURES:
        str = "PHYSICAL_DEVICE_VERTEX_ATTRIBUTE_DIVISOR_FEATURES";
        break;
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_INDEX_TYPE_UINT8_FEATURES: str = "PHYSICAL_DEVICE_INDEX_TYPE_UINT8_FEATURES"; break;
    case VK_STRUCTURE_TYPE_MEMORY_MAP_INFO: str = "MEMORY_MAP_INFO"; break;
    case VK_STRUCTURE_TYPE_MEMORY_UNMAP_INFO: str = "MEMORY_UNMAP_INFO"; break;
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MAINTENANCE_5_FEATURES: str = "PHYSICAL_DEVICE_MAINTENANCE_5_FEATURES"; break;
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MAINTENANCE_5_PROPERTIES: str = "PHYSICAL_DEVICE_MAINTENANCE_5_PROPERTIES"; break;
    case VK_STRUCTURE_TYPE_RENDERING_AREA_INFO: str = "RENDERING_AREA_INFO"; break;
    case VK_STRUCTURE_TYPE_DEVICE_IMAGE_SUBRESOURCE_INFO: str = "DEVICE_IMAGE_SUBRESOURCE_INFO"; break;
    case VK_STRUCTURE_TYPE_SUBRESOURCE_LAYOUT_2: str = "SUBRESOURCE_LAYOUT_2"; break;
    case VK_STRUCTURE_TYPE_IMAGE_SUBRESOURCE_2: str = "IMAGE_SUBRESOURCE_2"; break;
    case VK_STRUCTURE_TYPE_PIPELINE_CREATE_FLAGS_2_CREATE_INFO: str = "PIPELINE_CREATE_FLAGS_2_CREATE_INFO"; break;
    case VK_STRUCTURE_TYPE_BUFFER_USAGE_FLAGS_2_CREATE_INFO: str = "BUFFER_USAGE_FLAGS_2_CREATE_INFO"; break;
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PUSH_DESCRIPTOR_PROPERTIES:
        str = "PHYSICAL_DEVICE_PUSH_DESCRIPTOR_PROPERTIES";
        break;
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DYNAMIC_RENDERING_LOCAL_READ_FEATURES:
        str = "PHYSICAL_DEVICE_DYNAMIC_RENDERING_LOCAL_READ_FEATURES";
        break;
    case VK_STRUCTURE_TYPE_RENDERING_ATTACHMENT_LOCATION_INFO: str = "RENDERING_ATTACHMENT_LOCATION_INFO"; break;
    case VK_STRUCTURE_TYPE_RENDERING_INPUT_ATTACHMENT_INDEX_INFO: str = "RENDERING_INPUT_ATTACHMENT_INDEX_INFO"; break;
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MAINTENANCE_6_FEATURES: str = "PHYSICAL_DEVICE_MAINTENANCE_6_FEATURES"; break;
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MAINTENANCE_6_PROPERTIES: str = "PHYSICAL_DEVICE_MAINTENANCE_6_PROPERTIES"; break;
    case VK_STRUCTURE_TYPE_BIND_MEMORY_STATUS: str = "BIND_MEMORY_STATUS"; break;
    case VK_STRUCTURE_TYPE_BIND_DESCRIPTOR_SETS_INFO: str = "BIND_DESCRIPTOR_SETS_INFO"; break;
    case VK_STRUCTURE_TYPE_PUSH_CONSTANTS_INFO: str = "PUSH_CONSTANTS_INFO"; break;
    case VK_STRUCTURE_TYPE_PUSH_DESCRIPTOR_SET_INFO: str = "PUSH_DESCRIPTOR_SET_INFO"; break;
    case VK_STRUCTURE_TYPE_PUSH_DESCRIPTOR_SET_WITH_TEMPLATE_INFO: str = "PUSH_DESCRIPTOR_SET_WITH_TEMPLATE_INFO"; break;
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PIPELINE_PROTECTED_ACCESS_FEATURES:
        str = "PHYSICAL_DEVICE_PIPELINE_PROTECTED_ACCESS_FEATURES";
        break;
    case VK_STRUCTURE_TYPE_PIPELINE_ROBUSTNESS_CREATE_INFO: str = "PIPELINE_ROBUSTNESS_CREATE_INFO"; break;
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PIPELINE_ROBUSTNESS_FEATURES:
        str = "PHYSICAL_DEVICE_PIPELINE_ROBUSTNESS_FEATURES";
        break;
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PIPELINE_ROBUSTNESS_PROPERTIES:
        str = "PHYSICAL_DEVICE_PIPELINE_ROBUSTNESS_PROPERTIES";
        break;
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_HOST_IMAGE_COPY_FEATURES: str = "PHYSICAL_DEVICE_HOST_IMAGE_COPY_FEATURES"; break;
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_HOST_IMAGE_COPY_PROPERTIES:
        str = "PHYSICAL_DEVICE_HOST_IMAGE_COPY_PROPERTIES";
        break;
    case VK_STRUCTURE_TYPE_MEMORY_TO_IMAGE_COPY: str = "MEMORY_TO_IMAGE_COPY"; break;
    case VK_STRUCTURE_TYPE_IMAGE_TO_MEMORY_COPY: str = "IMAGE_TO_MEMORY_COPY"; break;
    case VK_STRUCTURE_TYPE_COPY_IMAGE_TO_MEMORY_INFO: str = "COPY_IMAGE_TO_MEMORY_INFO"; break;
    case VK_STRUCTURE_TYPE_COPY_MEMORY_TO_IMAGE_INFO: str = "COPY_MEMORY_TO_IMAGE_INFO"; break;
    case VK_STRUCTURE_TYPE_HOST_IMAGE_LAYOUT_TRANSITION_INFO: str = "HOST_IMAGE_LAYOUT_TRANSITION_INFO"; break;
    case VK_STRUCTURE_TYPE_COPY_IMAGE_TO_IMAGE_INFO: str = "COPY_IMAGE_TO_IMAGE_INFO"; break;
    case VK_STRUCTURE_TYPE_SUBRESOURCE_HOST_MEMCPY_SIZE: str = "SUBRESOURCE_HOST_MEMCPY_SIZE"; break;
    case VK_STRUCTURE_TYPE_HOST_IMAGE_COPY_DEVICE_PERFORMANCE_QUERY: str = "HOST_IMAGE_COPY_DEVICE_PERFORMANCE_QUERY"; break;
    ...
    case VK_STRUCTURE_TYPE_CU_MODULE_TEXTURING_MODE_CREATE_INFO_NVX: str = "CU_MODULE_TEXTURING_MODE_CREATE_INFO_NVX"; break;
    ...
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_BFLOAT16_FEATURES_KHR:
        str = "PHYSICAL_DEVICE_SHADER_BFLOAT16_FEATURES_KHR";
        break;
    ...
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_TILE_SHADING_FEATURES_QCOM:
        str = "PHYSICAL_DEVICE_TILE_SHADING_FEATURES_QCOM";
        break;
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_TILE_SHADING_PROPERTIES_QCOM:
        str = "PHYSICAL_DEVICE_TILE_SHADING_PROPERTIES_QCOM";
        break;
    case VK_STRUCTURE_TYPE_RENDER_PASS_TILE_SHADING_CREATE_INFO_QCOM: str = "RENDER_PASS_TILE_SHADING_CREATE_INFO_QCOM"; break;
    case VK_STRUCTURE_TYPE_PER_TILE_BEGIN_INFO_QCOM: str = "PER_TILE_BEGIN_INFO_QCOM"; break;
    case VK_STRUCTURE_TYPE_PER_TILE_END_INFO_QCOM: str = "PER_TILE_END_INFO_QCOM"; break;
    case VK_STRUCTURE_TYPE_DISPATCH_TILE_INFO_QCOM: str = "DISPATCH_TILE_INFO_QCOM"; break;
    ...
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_RAY_TRACING_LINEAR_SWEPT_SPHERES_FEATURES_NV:
        str = "PHYSICAL_DEVICE_RAY_TRACING_LINEAR_SWEPT_SPHERES_FEATURES_NV";
        break;
    case VK_STRUCTURE_TYPE_ACCELERATION_STRUCTURE_GEOMETRY_LINEAR_SWEPT_SPHERES_DATA_NV:
        str = "ACCELERATION_STRUCTURE_GEOMETRY_LINEAR_SWEPT_SPHERES_DATA_NV";
        break;
    case VK_STRUCTURE_TYPE_ACCELERATION_STRUCTURE_GEOMETRY_SPHERES_DATA_NV:
        str = "ACCELERATION_STRUCTURE_GEOMETRY_SPHERES_DATA_NV";
        break;
    ...
    case VK_STRUCTURE_TYPE_TENSOR_CREATE_INFO_ARM: str = "TENSOR_CREATE_INFO_ARM"; break;
    case VK_STRUCTURE_TYPE_TENSOR_VIEW_CREATE_INFO_ARM: str = "TENSOR_VIEW_CREATE_INFO_ARM"; break;
    case VK_STRUCTURE_TYPE_BIND_TENSOR_MEMORY_INFO_ARM: str = "BIND_TENSOR_MEMORY_INFO_ARM"; break;
    case VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET_TENSOR_ARM: str = "WRITE_DESCRIPTOR_SET_TENSOR_ARM"; break;
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_TENSOR_PROPERTIES_ARM: str = "PHYSICAL_DEVICE_TENSOR_PROPERTIES_ARM"; break;
    case VK_STRUCTURE_TYPE_TENSOR_FORMAT_PROPERTIES_ARM: str = "TENSOR_FORMAT_PROPERTIES_ARM"; break;
    case VK_STRUCTURE_TYPE_TENSOR_DESCRIPTION_ARM: str = "TENSOR_DESCRIPTION_ARM"; break;
    case VK_STRUCTURE_TYPE_TENSOR_MEMORY_REQUIREMENTS_INFO_ARM: str = "TENSOR_MEMORY_REQUIREMENTS_INFO_ARM"; break;
    case VK_STRUCTURE_TYPE_TENSOR_MEMORY_BARRIER_ARM: str = "TENSOR_MEMORY_BARRIER_ARM"; break;
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_TENSOR_FEATURES_ARM: str = "PHYSICAL_DEVICE_TENSOR_FEATURES_ARM"; break;
    case VK_STRUCTURE_TYPE_DEVICE_TENSOR_MEMORY_REQUIREMENTS_ARM: str = "DEVICE_TENSOR_MEMORY_REQUIREMENTS_ARM"; break;
    case VK_STRUCTURE_TYPE_COPY_TENSOR_INFO_ARM: str = "COPY_TENSOR_INFO_ARM"; break;
    case VK_STRUCTURE_TYPE_TENSOR_COPY_ARM: str = "TENSOR_COPY_ARM"; break;
    case VK_STRUCTURE_TYPE_TENSOR_DEPENDENCY_INFO_ARM: str = "TENSOR_DEPENDENCY_INFO_ARM"; break;
    case VK_STRUCTURE_TYPE_MEMORY_DEDICATED_ALLOCATE_INFO_TENSOR_ARM: str = "MEMORY_DEDICATED_ALLOCATE_INFO_TENSOR_ARM"; break;
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTERNAL_TENSOR_INFO_ARM: str = "PHYSICAL_DEVICE_EXTERNAL_TENSOR_INFO_ARM"; break;
    case VK_STRUCTURE_TYPE_EXTERNAL_TENSOR_PROPERTIES_ARM: str = "EXTERNAL_TENSOR_PROPERTIES_ARM"; break;
    case VK_STRUCTURE_TYPE_EXTERNAL_MEMORY_TENSOR_CREATE_INFO_ARM: str = "EXTERNAL_MEMORY_TENSOR_CREATE_INFO_ARM"; break;
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DESCRIPTOR_BUFFER_TENSOR_FEATURES_ARM:
        str = "PHYSICAL_DEVICE_DESCRIPTOR_BUFFER_TENSOR_FEATURES_ARM";
        break;
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DESCRIPTOR_BUFFER_TENSOR_PROPERTIES_ARM:
        str = "PHYSICAL_DEVICE_DESCRIPTOR_BUFFER_TENSOR_PROPERTIES_ARM";
        break;
    case VK_STRUCTURE_TYPE_DESCRIPTOR_GET_TENSOR_INFO_ARM: str = "DESCRIPTOR_GET_TENSOR_INFO_ARM"; break;
    case VK_STRUCTURE_TYPE_TENSOR_CAPTURE_DESCRIPTOR_DATA_INFO_ARM: str = "TENSOR_CAPTURE_DESCRIPTOR_DATA_INFO_ARM"; break;
    case VK_STRUCTURE_TYPE_TENSOR_VIEW_CAPTURE_DESCRIPTOR_DATA_INFO_ARM:
        str = "TENSOR_VIEW_CAPTURE_DESCRIPTOR_DATA_INFO_ARM";
        break;
    case VK_STRUCTURE_TYPE_FRAME_BOUNDARY_TENSORS_ARM: str = "FRAME_BOUNDARY_TENSORS_ARM"; break;
    ...
    case VK_STRUCTURE_TYPE_ANDROID_HARDWARE_BUFFER_FORMAT_RESOLVE_PROPERTIES_ANDROID:
        ...
        break;
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_ANTI_LAG_FEATURES_AMD: str = "PHYSICAL_DEVICE_ANTI_LAG_FEATURES_AMD"; break;
    case VK_STRUCTURE_TYPE_ANTI_LAG_DATA_AMD: str = "ANTI_LAG_DATA_AMD"; break;
    case VK_STRUCTURE_TYPE_ANTI_LAG_PRESENTATION_INFO_AMD: str = "ANTI_LAG_PRESENTATION_INFO_AMD"; break;
    case VK_STRUCTURE_TYPE_SURFACE_CAPABILITIES_PRESENT_ID_2_KHR: str = "SURFACE_CAPABILITIES_PRESENT_ID_2_KHR"; break;
    case VK_STRUCTURE_TYPE_PRESENT_ID_2_KHR: str = "PRESENT_ID_2_KHR"; break;
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PRESENT_ID_2_FEATURES_KHR: str = "PHYSICAL_DEVICE_PRESENT_ID_2_FEATURES_KHR"; break;
    case VK_STRUCTURE_TYPE_SURFACE_CAPABILITIES_PRESENT_WAIT_2_KHR: str = "SURFACE_CAPABILITIES_PRESENT_WAIT_2_KHR"; break;
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PRESENT_WAIT_2_FEATURES_KHR:
        str = "PHYSICAL_DEVICE_PRESENT_WAIT_2_FEATURES_KHR";
        break;
    case VK_STRUCTURE_TYPE_PRESENT_WAIT_2_INFO_KHR: str = "PRESENT_WAIT_2_INFO_KHR"; break;
    ...
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PIPELINE_BINARY_FEATURES_KHR:
        str = "PHYSICAL_DEVICE_PIPELINE_BINARY_FEATURES_KHR";
        break;
    case VK_STRUCTURE_TYPE_PIPELINE_BINARY_CREATE_INFO_KHR: str = "PIPELINE_BINARY_CREATE_INFO_KHR"; break;
    case VK_STRUCTURE_TYPE_PIPELINE_BINARY_INFO_KHR: str = "PIPELINE_BINARY_INFO_KHR"; break;
    case VK_STRUCTURE_TYPE_PIPELINE_BINARY_KEY_KHR: str = "PIPELINE_BINARY_KEY_KHR"; break;
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PIPELINE_BINARY_PROPERTIES_KHR:
        str = "PHYSICAL_DEVICE_PIPELINE_BINARY_PROPERTIES_KHR";
        break;
    case VK_STRUCTURE_TYPE_RELEASE_CAPTURED_PIPELINE_DATA_INFO_KHR: str = "RELEASE_CAPTURED_PIPELINE_DATA_INFO_KHR"; break;
    case VK_STRUCTURE_TYPE_PIPELINE_BINARY_DATA_INFO_KHR: str = "PIPELINE_BINARY_DATA_INFO_KHR"; break;
    case VK_STRUCTURE_TYPE_PIPELINE_CREATE_INFO_KHR: str = "PIPELINE_CREATE_INFO_KHR"; break;
    case VK_STRUCTURE_TYPE_DEVICE_PIPELINE_BINARY_INTERNAL_CACHE_CONTROL_KHR:
        str = "DEVICE_PIPELINE_BINARY_INTERNAL_CACHE_CONTROL_KHR";
        break;
    case VK_STRUCTURE_TYPE_PIPELINE_BINARY_HANDLES_INFO_KHR: str = "PIPELINE_BINARY_HANDLES_INFO_KHR"; break;
    ...
    case VK_STRUCTURE_TYPE_SURFACE_PRESENT_MODE_KHR: str = "SURFACE_PRESENT_MODE_KHR"; break;
    case VK_STRUCTURE_TYPE_SURFACE_PRESENT_SCALING_CAPABILITIES_KHR: str = "SURFACE_PRESENT_SCALING_CAPABILITIES_KHR"; break;
    case VK_STRUCTURE_TYPE_SURFACE_PRESENT_MODE_COMPATIBILITY_KHR: str = "SURFACE_PRESENT_MODE_COMPATIBILITY_KHR"; break;
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SWAPCHAIN_MAINTENANCE_1_FEATURES_KHR:
        str = "PHYSICAL_DEVICE_SWAPCHAIN_MAINTENANCE_1_FEATURES_KHR";
        break;
    case VK_STRUCTURE_TYPE_SWAPCHAIN_PRESENT_FENCE_INFO_KHR: str = "SWAPCHAIN_PRESENT_FENCE_INFO_KHR"; break;
    case VK_STRUCTURE_TYPE_SWAPCHAIN_PRESENT_MODES_CREATE_INFO_KHR: str = "SWAPCHAIN_PRESENT_MODES_CREATE_INFO_KHR"; break;
    case VK_STRUCTURE_TYPE_SWAPCHAIN_PRESENT_MODE_INFO_KHR: str = "SWAPCHAIN_PRESENT_MODE_INFO_KHR"; break;
    case VK_STRUCTURE_TYPE_SWAPCHAIN_PRESENT_SCALING_CREATE_INFO_KHR: str = "SWAPCHAIN_PRESENT_SCALING_CREATE_INFO_KHR"; break;
    case VK_STRUCTURE_TYPE_RELEASE_SWAPCHAIN_IMAGES_INFO_KHR: str = "RELEASE_SWAPCHAIN_IMAGES_INFO_KHR"; break;
    ...
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_COOPERATIVE_VECTOR_FEATURES_NV:
        str = "PHYSICAL_DEVICE_COOPERATIVE_VECTOR_FEATURES_NV";
        break;
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_COOPERATIVE_VECTOR_PROPERTIES_NV:
        str = "PHYSICAL_DEVICE_COOPERATIVE_VECTOR_PROPERTIES_NV";
        break;
    case VK_STRUCTURE_TYPE_COOPERATIVE_VECTOR_PROPERTIES_NV: str = "COOPERATIVE_VECTOR_PROPERTIES_NV"; break;
    case VK_STRUCTURE_TYPE_CONVERT_COOPERATIVE_VECTOR_MATRIX_INFO_NV: str = "CONVERT_COOPERATIVE_VECTOR_MATRIX_INFO_NV"; break;
    ...
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_LEGACY_VERTEX_ATTRIBUTES_FEATURES_EXT:
        str = "PHYSICAL_DEVICE_LEGACY_VERTEX_ATTRIBUTES_FEATURES_EXT";
        break;
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_LEGACY_VERTEX_ATTRIBUTES_PROPERTIES_EXT:
        str = "PHYSICAL_DEVICE_LEGACY_VERTEX_ATTRIBUTES_PROPERTIES_EXT";
        break;
    ...
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_COOPERATIVE_MATRIX_PROPERTIES_KHR:
        ...
        break;
    case VK_STRUCTURE_TYPE_DATA_GRAPH_PIPELINE_CREATE_INFO_ARM: str = "DATA_GRAPH_PIPELINE_CREATE_INFO_ARM"; break;
    case VK_STRUCTURE_TYPE_DATA_GRAPH_PIPELINE_SESSION_CREATE_INFO_ARM:
        str = "DATA_GRAPH_PIPELINE_SESSION_CREATE_INFO_ARM";
        break;
    case VK_STRUCTURE_TYPE_DATA_GRAPH_PIPELINE_RESOURCE_INFO_ARM: str = "DATA_GRAPH_PIPELINE_RESOURCE_INFO_ARM"; break;
    case VK_STRUCTURE_TYPE_DATA_GRAPH_PIPELINE_CONSTANT_ARM: str = "DATA_GRAPH_PIPELINE_CONSTANT_ARM"; break;
    case VK_STRUCTURE_TYPE_DATA_GRAPH_PIPELINE_SESSION_MEMORY_REQUIREMENTS_INFO_ARM:
        str = "DATA_GRAPH_PIPELINE_SESSION_MEMORY_REQUIREMENTS_INFO_ARM";
        break;
    case VK_STRUCTURE_TYPE_BIND_DATA_GRAPH_PIPELINE_SESSION_MEMORY_INFO_ARM:
        str = "BIND_DATA_GRAPH_PIPELINE_SESSION_MEMORY_INFO_ARM";
        break;
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DATA_GRAPH_FEATURES_ARM: str = "PHYSICAL_DEVICE_DATA_GRAPH_FEATURES_ARM"; break;
    case VK_STRUCTURE_TYPE_DATA_GRAPH_PIPELINE_SHADER_MODULE_CREATE_INFO_ARM:
        str = "DATA_GRAPH_PIPELINE_SHADER_MODULE_CREATE_INFO_ARM";
        break;
    case VK_STRUCTURE_TYPE_DATA_GRAPH_PIPELINE_PROPERTY_QUERY_RESULT_ARM:
        str = "DATA_GRAPH_PIPELINE_PROPERTY_QUERY_RESULT_ARM";
        break;
    case VK_STRUCTURE_TYPE_DATA_GRAPH_PIPELINE_INFO_ARM: str = "DATA_GRAPH_PIPELINE_INFO_ARM"; break;
    case VK_STRUCTURE_TYPE_DATA_GRAPH_PIPELINE_COMPILER_CONTROL_CREATE_INFO_ARM:
        str = "DATA_GRAPH_PIPELINE_COMPILER_CONTROL_CREATE_INFO_ARM";
        break;
    case VK_STRUCTURE_TYPE_DATA_GRAPH_PIPELINE_SESSION_BIND_POINT_REQUIREMENTS_INFO_ARM:
        str = "DATA_GRAPH_PIPELINE_SESSION_BIND_POINT_REQUIREMENTS_INFO_ARM";
        break;
    case VK_STRUCTURE_TYPE_DATA_GRAPH_PIPELINE_SESSION_BIND_POINT_REQUIREMENT_ARM:
        str = "DATA_GRAPH_PIPELINE_SESSION_BIND_POINT_REQUIREMENT_ARM";
        break;
    case VK_STRUCTURE_TYPE_DATA_GRAPH_PIPELINE_IDENTIFIER_CREATE_INFO_ARM:
        str = "DATA_GRAPH_PIPELINE_IDENTIFIER_CREATE_INFO_ARM";
        break;
    case VK_STRUCTURE_TYPE_DATA_GRAPH_PIPELINE_DISPATCH_INFO_ARM: str = "DATA_GRAPH_PIPELINE_DISPATCH_INFO_ARM"; break;
    case VK_STRUCTURE_TYPE_DATA_GRAPH_PROCESSING_ENGINE_CREATE_INFO_ARM:
        str = "DATA_GRAPH_PROCESSING_ENGINE_CREATE_INFO_ARM";
        break;
    case VK_STRUCTURE_TYPE_QUEUE_FAMILY_DATA_GRAPH_PROCESSING_ENGINE_PROPERTIES_ARM:
        str = "QUEUE_FAMILY_DATA_GRAPH_PROCESSING_ENGINE_PROPERTIES_ARM";
        break;
    case VK_STRUCTURE_TYPE_QUEUE_FAMILY_DATA_GRAPH_PROPERTIES_ARM: str = "QUEUE_FAMILY_DATA_GRAPH_PROPERTIES_ARM"; break;
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_QUEUE_FAMILY_DATA_GRAPH_PROCESSING_ENGINE_INFO_ARM:
        str = "PHYSICAL_DEVICE_QUEUE_FAMILY_DATA_GRAPH_PROCESSING_ENGINE_INFO_ARM";
        break;
    case VK_STRUCTURE_TYPE_DATA_GRAPH_PIPELINE_CONSTANT_TENSOR_SEMI_STRUCTURED_SPARSITY_INFO_ARM:
        str = "DATA_GRAPH_PIPELINE_CONSTANT_TENSOR_SEMI_STRUCTURED_SPARSITY_INFO_ARM";
        break;
    ...
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_COMPUTE_SHADER_DERIVATIVES_FEATURES_KHR:
        str = "PHYSICAL_DEVICE_COMPUTE_SHADER_DERIVATIVES_FEATURES_KHR";
        break;
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_COMPUTE_SHADER_DERIVATIVES_PROPERTIES_KHR:
        str = "PHYSICAL_DEVICE_COMPUTE_SHADER_DERIVATIVES_PROPERTIES_KHR";
        break;
    ...
    case VK_STRUCTURE_TYPE_VIDEO_ENCODE_AV1_CAPABILITIES_KHR: str = "VIDEO_ENCODE_AV1_CAPABILITIES_KHR"; break;
    case VK_STRUCTURE_TYPE_VIDEO_ENCODE_AV1_SESSION_PARAMETERS_CREATE_INFO_KHR:
        str = "VIDEO_ENCODE_AV1_SESSION_PARAMETERS_CREATE_INFO_KHR";
        break;
    case VK_STRUCTURE_TYPE_VIDEO_ENCODE_AV1_PICTURE_INFO_KHR: str = "VIDEO_ENCODE_AV1_PICTURE_INFO_KHR"; break;
    case VK_STRUCTURE_TYPE_VIDEO_ENCODE_AV1_DPB_SLOT_INFO_KHR: str = "VIDEO_ENCODE_AV1_DPB_SLOT_INFO_KHR"; break;
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VIDEO_ENCODE_AV1_FEATURES_KHR:
        str = "PHYSICAL_DEVICE_VIDEO_ENCODE_AV1_FEATURES_KHR";
        break;
    case VK_STRUCTURE_TYPE_VIDEO_ENCODE_AV1_PROFILE_INFO_KHR: str = "VIDEO_ENCODE_AV1_PROFILE_INFO_KHR"; break;
    case VK_STRUCTURE_TYPE_VIDEO_ENCODE_AV1_RATE_CONTROL_INFO_KHR: str = "VIDEO_ENCODE_AV1_RATE_CONTROL_INFO_KHR"; break;
    case VK_STRUCTURE_TYPE_VIDEO_ENCODE_AV1_RATE_CONTROL_LAYER_INFO_KHR:
        str = "VIDEO_ENCODE_AV1_RATE_CONTROL_LAYER_INFO_KHR";
        break;
    case VK_STRUCTURE_TYPE_VIDEO_ENCODE_AV1_QUALITY_LEVEL_PROPERTIES_KHR:
        str = "VIDEO_ENCODE_AV1_QUALITY_LEVEL_PROPERTIES_KHR";
        break;
    case VK_STRUCTURE_TYPE_VIDEO_ENCODE_AV1_SESSION_CREATE_INFO_KHR: str = "VIDEO_ENCODE_AV1_SESSION_CREATE_INFO_KHR"; break;
    case VK_STRUCTURE_TYPE_VIDEO_ENCODE_AV1_GOP_REMAINING_FRAME_INFO_KHR:
        str = "VIDEO_ENCODE_AV1_GOP_REMAINING_FRAME_INFO_KHR";
        break;
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VIDEO_DECODE_VP9_FEATURES_KHR:
        str = "PHYSICAL_DEVICE_VIDEO_DECODE_VP9_FEATURES_KHR";
        break;
    case VK_STRUCTURE_TYPE_VIDEO_DECODE_VP9_CAPABILITIES_KHR: str = "VIDEO_DECODE_VP9_CAPABILITIES_KHR"; break;
    case VK_STRUCTURE_TYPE_VIDEO_DECODE_VP9_PICTURE_INFO_KHR: str = "VIDEO_DECODE_VP9_PICTURE_INFO_KHR"; break;
    case VK_STRUCTURE_TYPE_VIDEO_DECODE_VP9_PROFILE_INFO_KHR: str = "VIDEO_DECODE_VP9_PROFILE_INFO_KHR"; break;
    ...
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_UNIFIED_IMAGE_LAYOUTS_FEATURES_KHR:
        str = "PHYSICAL_DEVICE_UNIFIED_IMAGE_LAYOUTS_FEATURES_KHR";
        break;
    case VK_STRUCTURE_TYPE_ATTACHMENT_FEEDBACK_LOOP_INFO_EXT: str = "ATTACHMENT_FEEDBACK_LOOP_INFO_EXT"; break;
    ...
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_TILE_MEMORY_HEAP_FEATURES_QCOM:
        str = "PHYSICAL_DEVICE_TILE_MEMORY_HEAP_FEATURES_QCOM";
        break;
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_TILE_MEMORY_HEAP_PROPERTIES_QCOM:
        str = "PHYSICAL_DEVICE_TILE_MEMORY_HEAP_PROPERTIES_QCOM";
        break;
    case VK_STRUCTURE_TYPE_TILE_MEMORY_REQUIREMENTS_QCOM: str = "TILE_MEMORY_REQUIREMENTS_QCOM"; break;
    case VK_STRUCTURE_TYPE_TILE_MEMORY_BIND_INFO_QCOM: str = "TILE_MEMORY_BIND_INFO_QCOM"; break;
    case VK_STRUCTURE_TYPE_TILE_MEMORY_SIZE_INFO_QCOM: str = "TILE_MEMORY_SIZE_INFO_QCOM"; break;
    case VK_STRUCTURE_TYPE_DISPLAY_SURFACE_STEREO_CREATE_INFO_NV: str = "DISPLAY_SURFACE_STEREO_CREATE_INFO_NV"; break;
    case VK_STRUCTURE_TYPE_DISPLAY_MODE_STEREO_PROPERTIES_NV: str = "DISPLAY_MODE_STEREO_PROPERTIES_NV"; break;
    case VK_STRUCTURE_TYPE_VIDEO_ENCODE_INTRA_REFRESH_CAPABILITIES_KHR:
        str = "VIDEO_ENCODE_INTRA_REFRESH_CAPABILITIES_KHR";
        break;
    case VK_STRUCTURE_TYPE_VIDEO_ENCODE_SESSION_INTRA_REFRESH_CREATE_INFO_KHR:
        str = "VIDEO_ENCODE_SESSION_INTRA_REFRESH_CREATE_INFO_KHR";
        break;
    case VK_STRUCTURE_TYPE_VIDEO_ENCODE_INTRA_REFRESH_INFO_KHR: str = "VIDEO_ENCODE_INTRA_REFRESH_INFO_KHR"; break;
    case VK_STRUCTURE_TYPE_VIDEO_REFERENCE_INTRA_REFRESH_INFO_KHR: str = "VIDEO_REFERENCE_INTRA_REFRESH_INFO_KHR"; break;
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VIDEO_ENCODE_INTRA_REFRESH_FEATURES_KHR:
        str = "PHYSICAL_DEVICE_VIDEO_ENCODE_INTRA_REFRESH_FEATURES_KHR";
        break;
    case VK_STRUCTURE_TYPE_VIDEO_ENCODE_QUANTIZATION_MAP_CAPABILITIES_KHR:
        str = "VIDEO_ENCODE_QUANTIZATION_MAP_CAPABILITIES_KHR";
        break;
    case VK_STRUCTURE_TYPE_VIDEO_FORMAT_QUANTIZATION_MAP_PROPERTIES_KHR:
        str = "VIDEO_FORMAT_QUANTIZATION_MAP_PROPERTIES_KHR";
        break;
    case VK_STRUCTURE_TYPE_VIDEO_ENCODE_QUANTIZATION_MAP_INFO_KHR: str = "VIDEO_ENCODE_QUANTIZATION_MAP_INFO_KHR"; break;
    case VK_STRUCTURE_TYPE_VIDEO_ENCODE_QUANTIZATION_MAP_SESSION_PARAMETERS_CREATE_INFO_KHR:
        str = "VIDEO_ENCODE_QUANTIZATION_MAP_SESSION_PARAMETERS_CREATE_INFO_KHR";
        break;
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VIDEO_ENCODE_QUANTIZATION_MAP_FEATURES_KHR:
        str = "PHYSICAL_DEVICE_VIDEO_ENCODE_QUANTIZATION_MAP_FEATURES_KHR";
        break;
    case VK_STRUCTURE_TYPE_VIDEO_ENCODE_H264_QUANTIZATION_MAP_CAPABILITIES_KHR:
        str = "VIDEO_ENCODE_H264_QUANTIZATION_MAP_CAPABILITIES_KHR";
        break;
    case VK_STRUCTURE_TYPE_VIDEO_ENCODE_H265_QUANTIZATION_MAP_CAPABILITIES_KHR:
        str = "VIDEO_ENCODE_H265_QUANTIZATION_MAP_CAPABILITIES_KHR";
        break;
    case VK_STRUCTURE_TYPE_VIDEO_FORMAT_H265_QUANTIZATION_MAP_PROPERTIES_KHR:
        str = "VIDEO_FORMAT_H265_QUANTIZATION_MAP_PROPERTIES_KHR";
        break;
    case VK_STRUCTURE_TYPE_VIDEO_ENCODE_AV1_QUANTIZATION_MAP_CAPABILITIES_KHR:
        str = "VIDEO_ENCODE_AV1_QUANTIZATION_MAP_CAPABILITIES_KHR";
        break;
    case VK_STRUCTURE_TYPE_VIDEO_FORMAT_AV1_QUANTIZATION_MAP_PROPERTIES_KHR:
        str = "VIDEO_FORMAT_AV1_QUANTIZATION_MAP_PROPERTIES_KHR";
        break;
    ...
    case VK_STRUCTURE_TYPE_EXTERNAL_COMPUTE_QUEUE_DEVICE_CREATE_INFO_NV:
        str = "EXTERNAL_COMPUTE_QUEUE_DEVICE_CREATE_INFO_NV";
        break;
    case VK_STRUCTURE_TYPE_EXTERNAL_COMPUTE_QUEUE_CREATE_INFO_NV: str = "EXTERNAL_COMPUTE_QUEUE_CREATE_INFO_NV"; break;
    case VK_STRUCTURE_TYPE_EXTERNAL_COMPUTE_QUEUE_DATA_PARAMS_NV: str = "EXTERNAL_COMPUTE_QUEUE_DATA_PARAMS_NV"; break;
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTERNAL_COMPUTE_QUEUE_PROPERTIES_NV:
        str = "PHYSICAL_DEVICE_EXTERNAL_COMPUTE_QUEUE_PROPERTIES_NV";
        break;
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_RELAXED_EXTENDED_INSTRUCTION_FEATURES_KHR:
        str = "PHYSICAL_DEVICE_SHADER_RELAXED_EXTENDED_INSTRUCTION_FEATURES_KHR";
        break;
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_COMMAND_BUFFER_INHERITANCE_FEATURES_NV:
        str = "PHYSICAL_DEVICE_COMMAND_BUFFER_INHERITANCE_FEATURES_NV";
        break;
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MAINTENANCE_7_FEATURES_KHR:
        str = "PHYSICAL_DEVICE_MAINTENANCE_7_FEATURES_KHR";
        break;
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MAINTENANCE_7_PROPERTIES_KHR:
        str = "PHYSICAL_DEVICE_MAINTENANCE_7_PROPERTIES_KHR";
        break;
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_LAYERED_API_PROPERTIES_LIST_KHR:
        str = "PHYSICAL_DEVICE_LAYERED_API_PROPERTIES_LIST_KHR";
        break;
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_LAYERED_API_PROPERTIES_KHR:
        str = "PHYSICAL_DEVICE_LAYERED_API_PROPERTIES_KHR";
        break;
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_LAYERED_API_VULKAN_PROPERTIES_KHR:
        str = "PHYSICAL_DEVICE_LAYERED_API_VULKAN_PROPERTIES_KHR";
        break;
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_ATOMIC_FLOAT16_VECTOR_FEATURES_NV:
        str = "PHYSICAL_DEVICE_SHADER_ATOMIC_FLOAT16_VECTOR_FEATURES_NV";
        break;
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_REPLICATED_COMPOSITES_FEATURES_EXT:
        str = "PHYSICAL_DEVICE_SHADER_REPLICATED_COMPOSITES_FEATURES_EXT";
        break;
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_FLOAT8_FEATURES_EXT:
        str = "PHYSICAL_DEVICE_SHADER_FLOAT8_FEATURES_EXT";
        break;
    ...
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_CLUSTER_ACCELERATION_STRUCTURE_FEATURES_NV:
        str = "PHYSICAL_DEVICE_CLUSTER_ACCELERATION_STRUCTURE_FEATURES_NV";
        break;
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_CLUSTER_ACCELERATION_STRUCTURE_PROPERTIES_NV:
        str = "PHYSICAL_DEVICE_CLUSTER_ACCELERATION_STRUCTURE_PROPERTIES_NV";
        break;
    case VK_STRUCTURE_TYPE_CLUSTER_ACCELERATION_STRUCTURE_CLUSTERS_BOTTOM_LEVEL_INPUT_NV:
        str = "CLUSTER_ACCELERATION_STRUCTURE_CLUSTERS_BOTTOM_LEVEL_INPUT_NV";
        break;
    case VK_STRUCTURE_TYPE_CLUSTER_ACCELERATION_STRUCTURE_TRIANGLE_CLUSTER_INPUT_NV:
        str = "CLUSTER_ACCELERATION_STRUCTURE_TRIANGLE_CLUSTER_INPUT_NV";
        break;
    case VK_STRUCTURE_TYPE_CLUSTER_ACCELERATION_STRUCTURE_MOVE_OBJECTS_INPUT_NV:
        str = "CLUSTER_ACCELERATION_STRUCTURE_MOVE_OBJECTS_INPUT_NV";
        break;
    case VK_STRUCTURE_TYPE_CLUSTER_ACCELERATION_STRUCTURE_INPUT_INFO_NV:
        str = "CLUSTER_ACCELERATION_STRUCTURE_INPUT_INFO_NV";
        break;
    case VK_STRUCTURE_TYPE_CLUSTER_ACCELERATION_STRUCTURE_COMMANDS_INFO_NV:
        str = "CLUSTER_ACCELERATION_STRUCTURE_COMMANDS_INFO_NV";
        break;
    case VK_STRUCTURE_TYPE_RAY_TRACING_PIPELINE_CLUSTER_ACCELERATION_STRUCTURE_CREATE_INFO_NV:
        str = "RAY_TRACING_PIPELINE_CLUSTER_ACCELERATION_STRUCTURE_CREATE_INFO_NV";
        break;
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PARTITIONED_ACCELERATION_STRUCTURE_FEATURES_NV:
        str = "PHYSICAL_DEVICE_PARTITIONED_ACCELERATION_STRUCTURE_FEATURES_NV";
        break;
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PARTITIONED_ACCELERATION_STRUCTURE_PROPERTIES_NV:
        str = "PHYSICAL_DEVICE_PARTITIONED_ACCELERATION_STRUCTURE_PROPERTIES_NV";
        break;
    case VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET_PARTITIONED_ACCELERATION_STRUCTURE_NV:
        str = "WRITE_DESCRIPTOR_SET_PARTITIONED_ACCELERATION_STRUCTURE_NV";
        break;
    case VK_STRUCTURE_TYPE_PARTITIONED_ACCELERATION_STRUCTURE_INSTANCES_INPUT_NV:
        str = "PARTITIONED_ACCELERATION_STRUCTURE_INSTANCES_INPUT_NV";
        break;
    case VK_STRUCTURE_TYPE_BUILD_PARTITIONED_ACCELERATION_STRUCTURE_INFO_NV:
        str = "BUILD_PARTITIONED_ACCELERATION_STRUCTURE_INFO_NV";
        break;
    case VK_STRUCTURE_TYPE_PARTITIONED_ACCELERATION_STRUCTURE_FLAGS_NV:
        str = "PARTITIONED_ACCELERATION_STRUCTURE_FLAGS_NV";
        break;
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DEVICE_GENERATED_COMMANDS_FEATURES_EXT:
        str = "PHYSICAL_DEVICE_DEVICE_GENERATED_COMMANDS_FEATURES_EXT";
        break;
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DEVICE_GENERATED_COMMANDS_PROPERTIES_EXT:
        str = "PHYSICAL_DEVICE_DEVICE_GENERATED_COMMANDS_PROPERTIES_EXT";
        break;
    case VK_STRUCTURE_TYPE_GENERATED_COMMANDS_MEMORY_REQUIREMENTS_INFO_EXT:
        str = "GENERATED_COMMANDS_MEMORY_REQUIREMENTS_INFO_EXT";
        break;
    case VK_STRUCTURE_TYPE_INDIRECT_EXECUTION_SET_CREATE_INFO_EXT: str = "INDIRECT_EXECUTION_SET_CREATE_INFO_EXT"; break;
    case VK_STRUCTURE_TYPE_GENERATED_COMMANDS_INFO_EXT: str = "GENERATED_COMMANDS_INFO_EXT"; break;
    case VK_STRUCTURE_TYPE_INDIRECT_COMMANDS_LAYOUT_CREATE_INFO_EXT: str = "INDIRECT_COMMANDS_LAYOUT_CREATE_INFO_EXT"; break;
    case VK_STRUCTURE_TYPE_INDIRECT_COMMANDS_LAYOUT_TOKEN_EXT: str = "INDIRECT_COMMANDS_LAYOUT_TOKEN_EXT"; break;
    case VK_STRUCTURE_TYPE_WRITE_INDIRECT_EXECUTION_SET_PIPELINE_EXT: str = "WRITE_INDIRECT_EXECUTION_SET_PIPELINE_EXT"; break;
    case VK_STRUCTURE_TYPE_WRITE_INDIRECT_EXECUTION_SET_SHADER_EXT: str = "WRITE_INDIRECT_EXECUTION_SET_SHADER_EXT"; break;
    case VK_STRUCTURE_TYPE_INDIRECT_EXECUTION_SET_PIPELINE_INFO_EXT: str = "INDIRECT_EXECUTION_SET_PIPELINE_INFO_EXT"; break;
    case VK_STRUCTURE_TYPE_INDIRECT_EXECUTION_SET_SHADER_INFO_EXT: str = "INDIRECT_EXECUTION_SET_SHADER_INFO_EXT"; break;
    case VK_STRUCTURE_TYPE_INDIRECT_EXECUTION_SET_SHADER_LAYOUT_INFO_EXT:
        str = "INDIRECT_EXECUTION_SET_SHADER_LAYOUT_INFO_EXT";
        break;
    case VK_STRUCTURE_TYPE_GENERATED_COMMANDS_PIPELINE_INFO_EXT: str = "GENERATED_COMMANDS_PIPELINE_INFO_EXT"; break;
    case VK_STRUCTURE_TYPE_GENERATED_COMMANDS_SHADER_INFO_EXT: str = "GENERATED_COMMANDS_SHADER_INFO_EXT"; break;
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MAINTENANCE_8_FEATURES_KHR:
        str = "PHYSICAL_DEVICE_MAINTENANCE_8_FEATURES_KHR";
        break;
    case VK_STRUCTURE_TYPE_MEMORY_BARRIER_ACCESS_FLAGS_3_KHR: str = "MEMORY_BARRIER_ACCESS_FLAGS_3_KHR"; break;
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_IMAGE_ALIGNMENT_CONTROL_FEATURES_MESA:
        str = "PHYSICAL_DEVICE_IMAGE_ALIGNMENT_CONTROL_FEATURES_MESA";
        break;
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_IMAGE_ALIGNMENT_CONTROL_PROPERTIES_MESA:
        str = "PHYSICAL_DEVICE_IMAGE_ALIGNMENT_CONTROL_PROPERTIES_MESA";
        break;
    case VK_STRUCTURE_TYPE_IMAGE_ALIGNMENT_CONTROL_CREATE_INFO_MESA: str = "IMAGE_ALIGNMENT_CONTROL_CREATE_INFO_MESA"; break;
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DEPTH_CLAMP_CONTROL_FEATURES_EXT:
        str = "PHYSICAL_DEVICE_DEPTH_CLAMP_CONTROL_FEATURES_EXT";
        break;
    case VK_STRUCTURE_TYPE_PIPELINE_VIEWPORT_DEPTH_CLAMP_CONTROL_CREATE_INFO_EXT:
        str = "PIPELINE_VIEWPORT_DEPTH_CLAMP_CONTROL_CREATE_INFO_EXT";
        break;
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MAINTENANCE_9_FEATURES_KHR:
        str = "PHYSICAL_DEVICE_MAINTENANCE_9_FEATURES_KHR";
        break;
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MAINTENANCE_9_PROPERTIES_KHR:
        str = "PHYSICAL_DEVICE_MAINTENANCE_9_PROPERTIES_KHR";
        break;
    case VK_STRUCTURE_TYPE_QUEUE_FAMILY_OWNERSHIP_TRANSFER_PROPERTIES_KHR:
        str = "QUEUE_FAMILY_OWNERSHIP_TRANSFER_PROPERTIES_KHR";
        break;
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VIDEO_MAINTENANCE_2_FEATURES_KHR:
        str = "PHYSICAL_DEVICE_VIDEO_MAINTENANCE_2_FEATURES_KHR";
        break;
    case VK_STRUCTURE_TYPE_VIDEO_DECODE_H264_INLINE_SESSION_PARAMETERS_INFO_KHR:
        str = "VIDEO_DECODE_H264_INLINE_SESSION_PARAMETERS_INFO_KHR";
        break;
    case VK_STRUCTURE_TYPE_VIDEO_DECODE_H265_INLINE_SESSION_PARAMETERS_INFO_KHR:
        str = "VIDEO_DECODE_H265_INLINE_SESSION_PARAMETERS_INFO_KHR";
        break;
    case VK_STRUCTURE_TYPE_VIDEO_DECODE_AV1_INLINE_SESSION_PARAMETERS_INFO_KHR:
        str = "VIDEO_DECODE_AV1_INLINE_SESSION_PARAMETERS_INFO_KHR";
        break;
    case VK_STRUCTURE_TYPE_OH_SURFACE_CREATE_INFO_OHOS: str = "OH_SURFACE_CREATE_INFO_OHOS"; break;
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_HDR_VIVID_FEATURES_HUAWEI: str = "PHYSICAL_DEVICE_HDR_VIVID_FEATURES_HUAWEI"; break;
    case VK_STRUCTURE_TYPE_HDR_VIVID_DYNAMIC_METADATA_HUAWEI: str = "HDR_VIVID_DYNAMIC_METADATA_HUAWEI"; break;
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_COOPERATIVE_MATRIX_2_FEATURES_NV:
        str = "PHYSICAL_DEVICE_COOPERATIVE_MATRIX_2_FEATURES_NV";
        break;
    case VK_STRUCTURE_TYPE_COOPERATIVE_MATRIX_FLEXIBLE_DIMENSIONS_PROPERTIES_NV:
        str = "COOPERATIVE_MATRIX_FLEXIBLE_DIMENSIONS_PROPERTIES_NV";
        break;
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_COOPERATIVE_MATRIX_2_PROPERTIES_NV:
        str = "PHYSICAL_DEVICE_COOPERATIVE_MATRIX_2_PROPERTIES_NV";
        break;
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PIPELINE_OPACITY_MICROMAP_FEATURES_ARM:
        str = "PHYSICAL_DEVICE_PIPELINE_OPACITY_MICROMAP_FEATURES_ARM";
        break;
    case VK_STRUCTURE_TYPE_IMPORT_MEMORY_METAL_HANDLE_INFO_EXT: str = "IMPORT_MEMORY_METAL_HANDLE_INFO_EXT"; break;
    case VK_STRUCTURE_TYPE_MEMORY_METAL_HANDLE_PROPERTIES_EXT: str = "MEMORY_METAL_HANDLE_PROPERTIES_EXT"; break;
    case VK_STRUCTURE_TYPE_MEMORY_GET_METAL_HANDLE_INFO_EXT: str = "MEMORY_GET_METAL_HANDLE_INFO_EXT"; break;
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DEPTH_CLAMP_ZERO_ONE_FEATURES_KHR:
        str = "PHYSICAL_DEVICE_DEPTH_CLAMP_ZERO_ONE_FEATURES_KHR";
        break;
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VERTEX_ATTRIBUTE_ROBUSTNESS_FEATURES_EXT:
        str = "PHYSICAL_DEVICE_VERTEX_ATTRIBUTE_ROBUSTNESS_FEATURES_EXT";
        break;
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FORMAT_PACK_FEATURES_ARM: str = "PHYSICAL_DEVICE_FORMAT_PACK_FEATURES_ARM"; break;
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FRAGMENT_DENSITY_MAP_LAYERED_FEATURES_VALVE:
        str = "PHYSICAL_DEVICE_FRAGMENT_DENSITY_MAP_LAYERED_FEATURES_VALVE";
        break;
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FRAGMENT_DENSITY_MAP_LAYERED_PROPERTIES_VALVE:
        str = "PHYSICAL_DEVICE_FRAGMENT_DENSITY_MAP_LAYERED_PROPERTIES_VALVE";
        break;
    case VK_STRUCTURE_TYPE_PIPELINE_FRAGMENT_DENSITY_MAP_LAYERED_CREATE_INFO_VALVE:
        str = "PIPELINE_FRAGMENT_DENSITY_MAP_LAYERED_CREATE_INFO_VALVE";
        break;
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_ROBUSTNESS_2_FEATURES_KHR: str = "PHYSICAL_DEVICE_ROBUSTNESS_2_FEATURES_KHR"; break;
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_ROBUSTNESS_2_PROPERTIES_KHR:
        str = "PHYSICAL_DEVICE_ROBUSTNESS_2_PROPERTIES_KHR";
        break;
#ifdef VK_ENABLE_BETA_EXTENSIONS
    case VK_STRUCTURE_TYPE_SET_PRESENT_CONFIG_NV: str = "SET_PRESENT_CONFIG_NV"; break;
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PRESENT_METERING_FEATURES_NV:
        str = "PHYSICAL_DEVICE_PRESENT_METERING_FEATURES_NV";
        break;
#endif // VK_ENABLE_BETA_EXTENSIONS
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FRAGMENT_DENSITY_MAP_OFFSET_FEATURES_EXT:
        str = "PHYSICAL_DEVICE_FRAGMENT_DENSITY_MAP_OFFSET_FEATURES_EXT";
        break;
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FRAGMENT_DENSITY_MAP_OFFSET_PROPERTIES_EXT:
        str = "PHYSICAL_DEVICE_FRAGMENT_DENSITY_MAP_OFFSET_PROPERTIES_EXT";
        break;
    case VK_STRUCTURE_TYPE_RENDER_PASS_FRAGMENT_DENSITY_MAP_OFFSET_END_INFO_EXT:
        str = "RENDER_PASS_FRAGMENT_DENSITY_MAP_OFFSET_END_INFO_EXT";
        break;
    case VK_STRUCTURE_TYPE_RENDERING_END_INFO_EXT: str = "RENDERING_END_INFO_EXT"; break;
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_ZERO_INITIALIZE_DEVICE_MEMORY_FEATURES_EXT:
        str = "PHYSICAL_DEVICE_ZERO_INITIALIZE_DEVICE_MEMORY_FEATURES_EXT";
        break;
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PRESENT_MODE_FIFO_LATEST_READY_FEATURES_KHR:
        str = "PHYSICAL_DEVICE_PRESENT_MODE_FIFO_LATEST_READY_FEATURES_KHR";
        break;
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PIPELINE_CACHE_INCREMENTAL_MODE_FEATURES_SEC:
        str = "PHYSICAL_DEVICE_PIPELINE_CACHE_INCREMENTAL_MODE_FEATURES_SEC";
        break;
    default: break;
    }
    return str;
...
String On_Str_VkImageLayout(VkImageLayout e) {
    ...
    case VK_IMAGE_LAYOUT_RENDERING_LOCAL_READ: str = "RENDERING_LOCAL_READ"; break;
    ...
    case VK_IMAGE_LAYOUT_TENSOR_ALIASING_ARM: str = "TENSOR_ALIASING_ARM"; break;
    case VK_IMAGE_LAYOUT_VIDEO_ENCODE_QUANTIZATION_MAP_KHR: str = "VIDEO_ENCODE_QUANTIZATION_MAP_KHR"; break;
    case VK_IMAGE_LAYOUT_ZERO_INITIALIZED_EXT: str = "ZERO_INITIALIZED_EXT"; break;
    default: break;
    }
    return str;
}
...
String On_Str_VkObjectType(VkObjectType e) {
    ...
    case VK_OBJECT_TYPE_TENSOR_ARM: str = "TENSOR_ARM"; break;
    case VK_OBJECT_TYPE_TENSOR_VIEW_ARM: str = "TENSOR_VIEW_ARM"; break;
    ...
    case VK_OBJECT_TYPE_PIPELINE_BINARY_KHR: str = "PIPELINE_BINARY_KHR"; break;
    case VK_OBJECT_TYPE_DATA_GRAPH_PIPELINE_SESSION_ARM: str = "DATA_GRAPH_PIPELINE_SESSION_ARM"; break;
    case VK_OBJECT_TYPE_EXTERNAL_COMPUTE_QUEUE_NV: str = "EXTERNAL_COMPUTE_QUEUE_NV"; break;
    case VK_OBJECT_TYPE_INDIRECT_COMMANDS_LAYOUT_EXT: str = "INDIRECT_COMMANDS_LAYOUT_EXT"; break;
    case VK_OBJECT_TYPE_INDIRECT_EXECUTION_SET_EXT: str = "INDIRECT_EXECUTION_SET_EXT"; break;
    default: break;
    }
    return str;
}
...
String On_Str_VkVendorId(VkVendorId e) {
    String str = "Unknown " + std::to_string(e);
    switch (e) {
    case VK_VENDOR_ID_KHRONOS: str = "KHRONOS"; break;
...
String On_Str_VkFormat(VkFormat e) {
    ...
    case VK_FORMAT_A1B5G5R5_UNORM_PACK16: str = "A1B5G5R5_UNORM_PACK16"; break;
    case VK_FORMAT_A8_UNORM: str = "A8_UNORM"; break;
    ...
    case VK_FORMAT_R8_BOOL_ARM: str = "R8_BOOL_ARM"; break;
    case VK_FORMAT_R16G16_SFIXED5_NV: str = "R16G16_SFIXED5_NV"; break;
    case VK_FORMAT_R10X6_UINT_PACK16_ARM: str = "R10X6_UINT_PACK16_ARM"; break;
    case VK_FORMAT_R10X6G10X6_UINT_2PACK16_ARM: str = "R10X6G10X6_UINT_2PACK16_ARM"; break;
    case VK_FORMAT_R10X6G10X6B10X6A10X6_UINT_4PACK16_ARM: str = "R10X6G10X6B10X6A10X6_UINT_4PACK16_ARM"; break;
    case VK_FORMAT_R12X4_UINT_PACK16_ARM: str = "R12X4_UINT_PACK16_ARM"; break;
    case VK_FORMAT_R12X4G12X4_UINT_2PACK16_ARM: str = "R12X4G12X4_UINT_2PACK16_ARM"; break;
    case VK_FORMAT_R12X4G12X4B12X4A12X4_UINT_4PACK16_ARM: str = "R12X4G12X4B12X4A12X4_UINT_4PACK16_ARM"; break;
    case VK_FORMAT_R14X2_UINT_PACK16_ARM: str = "R14X2_UINT_PACK16_ARM"; break;
    case VK_FORMAT_R14X2G14X2_UINT_2PACK16_ARM: str = "R14X2G14X2_UINT_2PACK16_ARM"; break;
    case VK_FORMAT_R14X2G14X2B14X2A14X2_UINT_4PACK16_ARM: str = "R14X2G14X2B14X2A14X2_UINT_4PACK16_ARM"; break;
    case VK_FORMAT_R14X2_UNORM_PACK16_ARM: str = "R14X2_UNORM_PACK16_ARM"; break;
    case VK_FORMAT_R14X2G14X2_UNORM_2PACK16_ARM: str = "R14X2G14X2_UNORM_2PACK16_ARM"; break;
    case VK_FORMAT_R14X2G14X2B14X2A14X2_UNORM_4PACK16_ARM: str = "R14X2G14X2B14X2A14X2_UNORM_4PACK16_ARM"; break;
    case VK_FORMAT_G14X2_B14X2R14X2_2PLANE_420_UNORM_3PACK16_ARM: str = "G14X2_B14X2R14X2_2PLANE_420_UNORM_3PACK16_ARM"; break;
    case VK_FORMAT_G14X2_B14X2R14X2_2PLANE_422_UNORM_3PACK16_ARM: str = "G14X2_B14X2R14X2_2PLANE_422_UNORM_3PACK16_ARM"; break;
    default: break;
    }
    return str;
}
...
String On_Str_VkDynamicState(VkDynamicState e) {
    ...
    case VK_DYNAMIC_STATE_LINE_STIPPLE: str = "LINE_STIPPLE"; break;
    ...
    case VK_DYNAMIC_STATE_DEPTH_CLAMP_RANGE_EXT: str = "DEPTH_CLAMP_RANGE_EXT"; break;
    default: break;
    }
    return str;
}
...
String On_Str_VkDescriptorType(VkDescriptorType e) {
    ...
    case VK_DESCRIPTOR_TYPE_TENSOR_ARM: str = "TENSOR_ARM"; break;
    case VK_DESCRIPTOR_TYPE_MUTABLE_EXT: str = "MUTABLE_EXT"; break;
    case VK_DESCRIPTOR_TYPE_PARTITIONED_ACCELERATION_STRUCTURE_NV: str = "PARTITIONED_ACCELERATION_STRUCTURE_NV"; break;
    default: break;
    }
    return str;
}
...
String On_Str_VkAttachmentLoadOp(VkAttachmentLoadOp e) {
    ...
    case VK_ATTACHMENT_LOAD_OP_NONE: str = "NONE"; break;
    default: break;
    }
    return str;
}
...
String On_Str_VkPipelineBindPoint(VkPipelineBindPoint e) {
    ...
    case VK_PIPELINE_BIND_POINT_DATA_GRAPH_ARM: str = "DATA_GRAPH_ARM"; break;
    default: break;
    }
    return str;
}
...
String On_Str_VkIndexType(VkIndexType e) {
    ...
    case VK_INDEX_TYPE_UINT8: str = "UINT8"; break;
...
String On_Str_VkSubpassContents(VkSubpassContents e) {
    ...
    case VK_SUBPASS_CONTENTS_INLINE_AND_SECONDARY_COMMAND_BUFFERS_KHR: str = "INLINE_AND_SECONDARY_COMMAND_BUFFERS_KHR"; break;
    default: break;
    }
    return str;
}
...
String On_Str_VkDescriptorUpdateTemplateType(VkDescriptorUpdateTemplateType e) {
    ...
    case VK_DESCRIPTOR_UPDATE_TEMPLATE_TYPE_PUSH_DESCRIPTORS: str = "PUSH_DESCRIPTORS"; break;
    default: break;
    }
    return str;
}
...
String On_Str_VkDriverId(VkDriverId e) {
    ...
    case VK_DRIVER_ID_MESA_HONEYKRISP: str = "MESA_HONEYKRISP"; break;
    case VK_DRIVER_ID_VULKAN_SC_EMULATION_ON_VULKAN: str = "VULKAN_SC_EMULATION_ON_VULKAN"; break;
    default: break;
    }
    return str;
}
...
String On_Str_VkPipelineRobustnessBufferBehavior(VkPipelineRobustnessBufferBehavior e) {
    String str = "Unknown " + std::to_string(e);
    switch (e) {
    case VK_PIPELINE_ROBUSTNESS_BUFFER_BEHAVIOR_DEVICE_DEFAULT: str = "DEVICE_DEFAULT"; break;
    case VK_PIPELINE_ROBUSTNESS_BUFFER_BEHAVIOR_DISABLED: str = "DISABLED"; break;
    case VK_PIPELINE_ROBUSTNESS_BUFFER_BEHAVIOR_ROBUST_BUFFER_ACCESS: str = "ROBUST_BUFFER_ACCESS"; break;
    case VK_PIPELINE_ROBUSTNESS_BUFFER_BEHAVIOR_ROBUST_BUFFER_ACCESS_2: str = "ROBUST_BUFFER_ACCESS_2"; break;
    default: break;
    }
    return str;
}
...
String On_Str_VkPipelineRobustnessImageBehavior(VkPipelineRobustnessImageBehavior e) {
    String str = "Unknown " + std::to_string(e);
    switch (e) {
    case VK_PIPELINE_ROBUSTNESS_IMAGE_BEHAVIOR_DEVICE_DEFAULT: str = "DEVICE_DEFAULT"; break;
    case VK_PIPELINE_ROBUSTNESS_IMAGE_BEHAVIOR_DISABLED: str = "DISABLED"; break;
    case VK_PIPELINE_ROBUSTNESS_IMAGE_BEHAVIOR_ROBUST_IMAGE_ACCESS: str = "ROBUST_IMAGE_ACCESS"; break;
    case VK_PIPELINE_ROBUSTNESS_IMAGE_BEHAVIOR_ROBUST_IMAGE_ACCESS_2: str = "ROBUST_IMAGE_ACCESS_2"; break;
    default: break;
    }
    return str;
}
...
String On_Str_VkQueueGlobalPriority(VkQueueGlobalPriority e) {
    String str = "Unknown " + std::to_string(e);
    switch (e) {
    case VK_QUEUE_GLOBAL_PRIORITY_LOW: str = "LOW"; break;
    case VK_QUEUE_GLOBAL_PRIORITY_MEDIUM: str = "MEDIUM"; break;
    case VK_QUEUE_GLOBAL_PRIORITY_HIGH: str = "HIGH"; break;
    case VK_QUEUE_GLOBAL_PRIORITY_REALTIME: str = "REALTIME"; break;
    default: break;
    }
    return str;
}
...
String On_Str_VkLineRasterizationMode(VkLineRasterizationMode e) {
    String str = "Unknown " + std::to_string(e);
    switch (e) {
    case VK_LINE_RASTERIZATION_MODE_DEFAULT: str = "DEFAULT"; break;
    case VK_LINE_RASTERIZATION_MODE_RECTANGULAR: str = "RECTANGULAR"; break;
    case VK_LINE_RASTERIZATION_MODE_BRESENHAM: str = "BRESENHAM"; break;
    case VK_LINE_RASTERIZATION_MODE_RECTANGULAR_SMOOTH: str = "RECTANGULAR_SMOOTH"; break;
    default: break;
    }
    return str;
}
...
String On_Str_VkPresentModeKHR(VkPresentModeKHR e) {
    ...
    case VK_PRESENT_MODE_FIFO_LATEST_READY_KHR: str = "VK_PRESENT_MODE_FIFO_LATEST_READY_KHR"; break;
    default: break;
    }
    return str;
}
...
String On_Str_VkComponentTypeKHR(VkComponentTypeKHR e) {
    ...
    case VK_COMPONENT_TYPE_BFLOAT16_KHR: str = "VK_COMPONENT_TYPE_BFLOAT16_KHR"; break;
    case VK_COMPONENT_TYPE_SINT8_PACKED_NV: str = "VK_COMPONENT_TYPE_SINT8_PACKED_NV"; break;
    case VK_COMPONENT_TYPE_UINT8_PACKED_NV: str = "VK_COMPONENT_TYPE_UINT8_PACKED_NV"; break;
    case VK_COMPONENT_TYPE_FLOAT8_E4M3_EXT: str = "VK_COMPONENT_TYPE_FLOAT8_E4M3_EXT"; break;
    case VK_COMPONENT_TYPE_FLOAT8_E5M2_EXT: str = "VK_COMPONENT_TYPE_FLOAT8_E5M2_EXT"; break;
    default: break;
    }
    return str;
}
...
String On_Str_VkVideoEncodeAV1PredictionModeKHR(VkVideoEncodeAV1PredictionModeKHR e) {
    String str = "Unknown " + std::to_string(e);
    switch (e) {
    case VK_VIDEO_ENCODE_AV1_PREDICTION_MODE_INTRA_ONLY_KHR: str = "VK_VIDEO_ENCODE_AV1_PREDICTION_MODE_INTRA_ONLY_KHR"; break;
    case VK_VIDEO_ENCODE_AV1_PREDICTION_MODE_SINGLE_REFERENCE_KHR:
        str = "VK_VIDEO_ENCODE_AV1_PREDICTION_MODE_SINGLE_REFERENCE_KHR";
        break;
    case VK_VIDEO_ENCODE_AV1_PREDICTION_MODE_UNIDIRECTIONAL_COMPOUND_KHR:
        str = "VK_VIDEO_ENCODE_AV1_PREDICTION_MODE_UNIDIRECTIONAL_COMPOUND_KHR";
        break;
    case VK_VIDEO_ENCODE_AV1_PREDICTION_MODE_BIDIRECTIONAL_COMPOUND_KHR:
        str = "VK_VIDEO_ENCODE_AV1_PREDICTION_MODE_BIDIRECTIONAL_COMPOUND_KHR";
        break;
    default: break;
    }
    return str;
...
String On_Str_VkVideoEncodeAV1RateControlGroupKHR(VkVideoEncodeAV1RateControlGroupKHR e) {
    String str = "Unknown " + std::to_string(e);
    switch (e) {
    case VK_VIDEO_ENCODE_AV1_RATE_CONTROL_GROUP_INTRA_KHR: str = "VK_VIDEO_ENCODE_AV1_RATE_CONTROL_GROUP_INTRA_KHR"; break;
    case VK_VIDEO_ENCODE_AV1_RATE_CONTROL_GROUP_PREDICTIVE_KHR:
        str = "VK_VIDEO_ENCODE_AV1_RATE_CONTROL_GROUP_PREDICTIVE_KHR";
        break;
    case VK_VIDEO_ENCODE_AV1_RATE_CONTROL_GROUP_BIPREDICTIVE_KHR:
        str = "VK_VIDEO_ENCODE_AV1_RATE_CONTROL_GROUP_BIPREDICTIVE_KHR";
        break;
    default: break;
    }
    return str;
...
String On_Str_VkPhysicalDeviceLayeredApiKHR(VkPhysicalDeviceLayeredApiKHR e) {
    String str = "Unknown " + std::to_string(e);
    switch (e) {
    case VK_PHYSICAL_DEVICE_LAYERED_API_VULKAN_KHR: str = "VK_PHYSICAL_DEVICE_LAYERED_API_VULKAN_KHR"; break;
    case VK_PHYSICAL_DEVICE_LAYERED_API_D3D12_KHR: str = "VK_PHYSICAL_DEVICE_LAYERED_API_D3D12_KHR"; break;
    case VK_PHYSICAL_DEVICE_LAYERED_API_METAL_KHR: str = "VK_PHYSICAL_DEVICE_LAYERED_API_METAL_KHR"; break;
    case VK_PHYSICAL_DEVICE_LAYERED_API_OPENGL_KHR: str = "VK_PHYSICAL_DEVICE_LAYERED_API_OPENGL_KHR"; break;
    case VK_PHYSICAL_DEVICE_LAYERED_API_OPENGLES_KHR: str = "VK_PHYSICAL_DEVICE_LAYERED_API_OPENGLES_KHR"; break;
    default: break;
    }
    return str;
}
...
String On_Str_VkDefaultVertexAttributeValueKHR(VkDefaultVertexAttributeValueKHR e) {
    ...
    case VK_DEFAULT_VERTEX_ATTRIBUTE_VALUE_ZERO_ZERO_ZERO_ZERO_KHR:
        str = "VK_DEFAULT_VERTEX_ATTRIBUTE_VALUE_ZERO_ZERO_ZERO_ZERO_KHR";
        break;
    case VK_DEFAULT_VERTEX_ATTRIBUTE_VALUE_ZERO_ZERO_ZERO_ONE_KHR:
        str = "VK_DEFAULT_VERTEX_ATTRIBUTE_VALUE_ZERO_ZERO_ZERO_ONE_KHR";
        break;
    default: break;
    }
    return str;
...
String On_Str_VkGeometryTypeKHR(VkGeometryTypeKHR e) {
    ...
    case VK_GEOMETRY_TYPE_SPHERES_NV: str = "VK_GEOMETRY_TYPE_SPHERES_NV"; break;
    case VK_GEOMETRY_TYPE_LINEAR_SWEPT_SPHERES_NV: str = "VK_GEOMETRY_TYPE_LINEAR_SWEPT_SPHERES_NV"; break;
    default: break;
    }
    return str;
}
...
String On_Str_VkOpacityMicromapSpecialIndexEXT(VkOpacityMicromapSpecialIndexEXT e) {
    ...
    case VK_OPACITY_MICROMAP_SPECIAL_INDEX_CLUSTER_GEOMETRY_DISABLE_OPACITY_MICROMAP_NV:
        str = "VK_OPACITY_MICROMAP_SPECIAL_INDEX_CLUSTER_GEOMETRY_DISABLE_OPACITY_MICROMAP_NV";
        break;
    default: break;
    }
    return str;
...
String On_Str_VkRayTracingLssIndexingModeNV(VkRayTracingLssIndexingModeNV e) {
    String str = "Unknown " + std::to_string(e);
    switch (e) {
    case VK_RAY_TRACING_LSS_INDEXING_MODE_LIST_NV: str = "VK_RAY_TRACING_LSS_INDEXING_MODE_LIST_NV"; break;
    case VK_RAY_TRACING_LSS_INDEXING_MODE_SUCCESSIVE_NV: str = "VK_RAY_TRACING_LSS_INDEXING_MODE_SUCCESSIVE_NV"; break;
    default: break;
    }
    return str;
}
...
String On_Str_VkRayTracingLssPrimitiveEndCapsModeNV(VkRayTracingLssPrimitiveEndCapsModeNV e) {
    String str = "Unknown " + std::to_string(e);
    switch (e) {
    case VK_RAY_TRACING_LSS_PRIMITIVE_END_CAPS_MODE_NONE_NV: str = "VK_RAY_TRACING_LSS_PRIMITIVE_END_CAPS_MODE_NONE_NV"; break;
    case VK_RAY_TRACING_LSS_PRIMITIVE_END_CAPS_MODE_CHAINED_NV:
        str = "VK_RAY_TRACING_LSS_PRIMITIVE_END_CAPS_MODE_CHAINED_NV";
        break;
    default: break;
    }
    return str;
...
String On_Str_VkTensorTilingARM(VkTensorTilingARM e) {
    String str = "Unknown " + std::to_string(e);
    switch (e) {
    case VK_TENSOR_TILING_OPTIMAL_ARM: str = "VK_TENSOR_TILING_OPTIMAL_ARM"; break;
    case VK_TENSOR_TILING_LINEAR_ARM: str = "VK_TENSOR_TILING_LINEAR_ARM"; break;
    default: break;
    }
    return str;
}
...
String On_Str_VkAntiLagModeAMD(VkAntiLagModeAMD e) {
    String str = "Unknown " + std::to_string(e);
    switch (e) {
    case VK_ANTI_LAG_MODE_DRIVER_CONTROL_AMD: str = "VK_ANTI_LAG_MODE_DRIVER_CONTROL_AMD"; break;
    case VK_ANTI_LAG_MODE_ON_AMD: str = "VK_ANTI_LAG_MODE_ON_AMD"; break;
    case VK_ANTI_LAG_MODE_OFF_AMD: str = "VK_ANTI_LAG_MODE_OFF_AMD"; break;
    default: break;
    }
    return str;
}
...
String On_Str_VkAntiLagStageAMD(VkAntiLagStageAMD e) {
    String str = "Unknown " + std::to_string(e);
    switch (e) {
    case VK_ANTI_LAG_STAGE_INPUT_AMD: str = "VK_ANTI_LAG_STAGE_INPUT_AMD"; break;
    case VK_ANTI_LAG_STAGE_PRESENT_AMD: str = "VK_ANTI_LAG_STAGE_PRESENT_AMD"; break;
    default: break;
    }
    return str;
}
...
String On_Str_VkDepthClampModeEXT(VkDepthClampModeEXT e) {
    String str = "Unknown " + std::to_string(e);
    switch (e) {
    case VK_DEPTH_CLAMP_MODE_VIEWPORT_RANGE_EXT: str = "VK_DEPTH_CLAMP_MODE_VIEWPORT_RANGE_EXT"; break;
    case VK_DEPTH_CLAMP_MODE_USER_DEFINED_RANGE_EXT: str = "VK_DEPTH_CLAMP_MODE_USER_DEFINED_RANGE_EXT"; break;
    default: break;
    }
    return str;
}
...
String On_Str_VkCooperativeVectorMatrixLayoutNV(VkCooperativeVectorMatrixLayoutNV e) {
    String str = "Unknown " + std::to_string(e);
    switch (e) {
    case VK_COOPERATIVE_VECTOR_MATRIX_LAYOUT_ROW_MAJOR_NV: str = "VK_COOPERATIVE_VECTOR_MATRIX_LAYOUT_ROW_MAJOR_NV"; break;
    case VK_COOPERATIVE_VECTOR_MATRIX_LAYOUT_COLUMN_MAJOR_NV:
        str = "VK_COOPERATIVE_VECTOR_MATRIX_LAYOUT_COLUMN_MAJOR_NV";
        break;
    case VK_COOPERATIVE_VECTOR_MATRIX_LAYOUT_INFERENCING_OPTIMAL_NV:
        str = "VK_COOPERATIVE_VECTOR_MATRIX_LAYOUT_INFERENCING_OPTIMAL_NV";
        break;
    case VK_COOPERATIVE_VECTOR_MATRIX_LAYOUT_TRAINING_OPTIMAL_NV:
        str = "VK_COOPERATIVE_VECTOR_MATRIX_LAYOUT_TRAINING_OPTIMAL_NV";
        break;
    default: break;
    }
    return str;
...
String On_Str_VkDataGraphPipelineSessionBindPointARM(VkDataGraphPipelineSessionBindPointARM e) {
    ...
    case VK_DATA_GRAPH_PIPELINE_SESSION_BIND_POINT_TRANSIENT_ARM:
        str = "VK_DATA_GRAPH_PIPELINE_SESSION_BIND_POINT_TRANSIENT_ARM";
        break;
    default: break;
    }
    return str;
...
String On_Str_VkDataGraphPipelineSessionBindPointTypeARM(VkDataGraphPipelineSessionBindPointTypeARM e) {
    ...
    case VK_DATA_GRAPH_PIPELINE_SESSION_BIND_POINT_TYPE_MEMORY_ARM:
        str = "VK_DATA_GRAPH_PIPELINE_SESSION_BIND_POINT_TYPE_MEMORY_ARM";
        break;
    default: break;
    }
    return str;
...
String On_Str_VkDataGraphPipelinePropertyARM(VkDataGraphPipelinePropertyARM e) {
    String str = "Unknown " + std::to_string(e);
    switch (e) {
    case VK_DATA_GRAPH_PIPELINE_PROPERTY_CREATION_LOG_ARM: str = "VK_DATA_GRAPH_PIPELINE_PROPERTY_CREATION_LOG_ARM"; break;
    case VK_DATA_GRAPH_PIPELINE_PROPERTY_IDENTIFIER_ARM: str = "VK_DATA_GRAPH_PIPELINE_PROPERTY_IDENTIFIER_ARM"; break;
    default: break;
    }
    return str;
}
...
String On_Str_VkPhysicalDeviceDataGraphProcessingEngineTypeARM(VkPhysicalDeviceDataGraphProcessingEngineTypeARM e) {
    ...
    case VK_PHYSICAL_DEVICE_DATA_GRAPH_PROCESSING_ENGINE_TYPE_DEFAULT_ARM:
        str = "VK_PHYSICAL_DEVICE_DATA_GRAPH_PROCESSING_ENGINE_TYPE_DEFAULT_ARM";
        break;
    default: break;
    }
    return str;
...
String On_Str_VkPhysicalDeviceDataGraphOperationTypeARM(VkPhysicalDeviceDataGraphOperationTypeARM e) {
    ...
    case VK_PHYSICAL_DEVICE_DATA_GRAPH_OPERATION_TYPE_SPIRV_EXTENDED_INSTRUCTION_SET_ARM:
        str = "VK_PHYSICAL_DEVICE_DATA_GRAPH_OPERATION_TYPE_SPIRV_EXTENDED_INSTRUCTION_SET_ARM";
        break;
    default: break;
    }
    return str;
...
String On_Str_VkDisplaySurfaceStereoTypeNV(VkDisplaySurfaceStereoTypeNV e) {
    String str = "Unknown " + std::to_string(e);
    switch (e) {
    case VK_DISPLAY_SURFACE_STEREO_TYPE_NONE_NV: str = "VK_DISPLAY_SURFACE_STEREO_TYPE_NONE_NV"; break;
    case VK_DISPLAY_SURFACE_STEREO_TYPE_ONBOARD_DIN_NV: str = "VK_DISPLAY_SURFACE_STEREO_TYPE_ONBOARD_DIN_NV"; break;
    case VK_DISPLAY_SURFACE_STEREO_TYPE_HDMI_3D_NV: str = "VK_DISPLAY_SURFACE_STEREO_TYPE_HDMI_3D_NV"; break;
    case VK_DISPLAY_SURFACE_STEREO_TYPE_INBAND_DISPLAYPORT_NV:
        str = "VK_DISPLAY_SURFACE_STEREO_TYPE_INBAND_DISPLAYPORT_NV";
        break;
    default: break;
    }
    return str;
...
String On_Str_VkClusterAccelerationStructureTypeNV(VkClusterAccelerationStructureTypeNV e) {
    ...
    case VK_CLUSTER_ACCELERATION_STRUCTURE_TYPE_CLUSTERS_BOTTOM_LEVEL_NV:
        str = "VK_CLUSTER_ACCELERATION_STRUCTURE_TYPE_CLUSTERS_BOTTOM_LEVEL_NV";
        break;
    case VK_CLUSTER_ACCELERATION_STRUCTURE_TYPE_TRIANGLE_CLUSTER_NV:
        str = "VK_CLUSTER_ACCELERATION_STRUCTURE_TYPE_TRIANGLE_CLUSTER_NV";
        break;
    case VK_CLUSTER_ACCELERATION_STRUCTURE_TYPE_TRIANGLE_CLUSTER_TEMPLATE_NV:
        str = "VK_CLUSTER_ACCELERATION_STRUCTURE_TYPE_TRIANGLE_CLUSTER_TEMPLATE_NV";
        break;
    default: break;
    }
    return str;
...
String On_Str_VkClusterAccelerationStructureOpTypeNV(VkClusterAccelerationStructureOpTypeNV e) {
    ...
    case VK_CLUSTER_ACCELERATION_STRUCTURE_OP_TYPE_MOVE_OBJECTS_NV:
        str = "VK_CLUSTER_ACCELERATION_STRUCTURE_OP_TYPE_MOVE_OBJECTS_NV";
        break;
    case VK_CLUSTER_ACCELERATION_STRUCTURE_OP_TYPE_BUILD_CLUSTERS_BOTTOM_LEVEL_NV:
        str = "VK_CLUSTER_ACCELERATION_STRUCTURE_OP_TYPE_BUILD_CLUSTERS_BOTTOM_LEVEL_NV";
        break;
    case VK_CLUSTER_ACCELERATION_STRUCTURE_OP_TYPE_BUILD_TRIANGLE_CLUSTER_NV:
        str = "VK_CLUSTER_ACCELERATION_STRUCTURE_OP_TYPE_BUILD_TRIANGLE_CLUSTER_NV";
        break;
    case VK_CLUSTER_ACCELERATION_STRUCTURE_OP_TYPE_BUILD_TRIANGLE_CLUSTER_TEMPLATE_NV:
        str = "VK_CLUSTER_ACCELERATION_STRUCTURE_OP_TYPE_BUILD_TRIANGLE_CLUSTER_TEMPLATE_NV";
        break;
    case VK_CLUSTER_ACCELERATION_STRUCTURE_OP_TYPE_INSTANTIATE_TRIANGLE_CLUSTER_NV:
        str = "VK_CLUSTER_ACCELERATION_STRUCTURE_OP_TYPE_INSTANTIATE_TRIANGLE_CLUSTER_NV";
        break;
    case VK_CLUSTER_ACCELERATION_STRUCTURE_OP_TYPE_GET_CLUSTER_TEMPLATE_INDICES_NV:
        str = "VK_CLUSTER_ACCELERATION_STRUCTURE_OP_TYPE_GET_CLUSTER_TEMPLATE_INDICES_NV";
        break;
    default: break;
    }
    return str;
...
String On_Str_VkClusterAccelerationStructureOpModeNV(VkClusterAccelerationStructureOpModeNV e) {
    ...
    case VK_CLUSTER_ACCELERATION_STRUCTURE_OP_MODE_IMPLICIT_DESTINATIONS_NV:
        str = "VK_CLUSTER_ACCELERATION_STRUCTURE_OP_MODE_IMPLICIT_DESTINATIONS_NV";
        break;
    case VK_CLUSTER_ACCELERATION_STRUCTURE_OP_MODE_EXPLICIT_DESTINATIONS_NV:
        str = "VK_CLUSTER_ACCELERATION_STRUCTURE_OP_MODE_EXPLICIT_DESTINATIONS_NV";
        break;
    case VK_CLUSTER_ACCELERATION_STRUCTURE_OP_MODE_COMPUTE_SIZES_NV:
        str = "VK_CLUSTER_ACCELERATION_STRUCTURE_OP_MODE_COMPUTE_SIZES_NV";
        break;
    default: break;
    }
    return str;
...
String On_Str_VkPartitionedAccelerationStructureOpTypeNV(VkPartitionedAccelerationStructureOpTypeNV e) {
    ...
    case VK_PARTITIONED_ACCELERATION_STRUCTURE_OP_TYPE_WRITE_INSTANCE_NV:
        str = "VK_PARTITIONED_ACCELERATION_STRUCTURE_OP_TYPE_WRITE_INSTANCE_NV";
        break;
    case VK_PARTITIONED_ACCELERATION_STRUCTURE_OP_TYPE_UPDATE_INSTANCE_NV:
        str = "VK_PARTITIONED_ACCELERATION_STRUCTURE_OP_TYPE_UPDATE_INSTANCE_NV";
        break;
    case VK_PARTITIONED_ACCELERATION_STRUCTURE_OP_TYPE_WRITE_PARTITION_TRANSLATION_NV:
        str = "VK_PARTITIONED_ACCELERATION_STRUCTURE_OP_TYPE_WRITE_PARTITION_TRANSLATION_NV";
        break;
    default: break;
    }
    return str;
...
String On_Str_VkIndirectExecutionSetInfoTypeEXT(VkIndirectExecutionSetInfoTypeEXT e) {
    String str = "Unknown " + std::to_string(e);
    switch (e) {
    case VK_INDIRECT_EXECUTION_SET_INFO_TYPE_PIPELINES_EXT: str = "VK_INDIRECT_EXECUTION_SET_INFO_TYPE_PIPELINES_EXT"; break;
    case VK_INDIRECT_EXECUTION_SET_INFO_TYPE_SHADER_OBJECTS_EXT:
        str = "VK_INDIRECT_EXECUTION_SET_INFO_TYPE_SHADER_OBJECTS_EXT";
        break;
    default: break;
    }
    return str;
...
String On_Str_VkIndirectCommandsTokenTypeEXT(VkIndirectCommandsTokenTypeEXT e) {
    String str = "Unknown " + std::to_string(e);
    switch (e) {
    case VK_INDIRECT_COMMANDS_TOKEN_TYPE_EXECUTION_SET_EXT: str = "VK_INDIRECT_COMMANDS_TOKEN_TYPE_EXECUTION_SET_EXT"; break;
    case VK_INDIRECT_COMMANDS_TOKEN_TYPE_PUSH_CONSTANT_EXT: str = "VK_INDIRECT_COMMANDS_TOKEN_TYPE_PUSH_CONSTANT_EXT"; break;
    case VK_INDIRECT_COMMANDS_TOKEN_TYPE_SEQUENCE_INDEX_EXT: str = "VK_INDIRECT_COMMANDS_TOKEN_TYPE_SEQUENCE_INDEX_EXT"; break;
    case VK_INDIRECT_COMMANDS_TOKEN_TYPE_INDEX_BUFFER_EXT: str = "VK_INDIRECT_COMMANDS_TOKEN_TYPE_INDEX_BUFFER_EXT"; break;
    case VK_INDIRECT_COMMANDS_TOKEN_TYPE_VERTEX_BUFFER_EXT: str = "VK_INDIRECT_COMMANDS_TOKEN_TYPE_VERTEX_BUFFER_EXT"; break;
    case VK_INDIRECT_COMMANDS_TOKEN_TYPE_DRAW_INDEXED_EXT: str = "VK_INDIRECT_COMMANDS_TOKEN_TYPE_DRAW_INDEXED_EXT"; break;
    case VK_INDIRECT_COMMANDS_TOKEN_TYPE_DRAW_EXT: str = "VK_INDIRECT_COMMANDS_TOKEN_TYPE_DRAW_EXT"; break;
    case VK_INDIRECT_COMMANDS_TOKEN_TYPE_DRAW_INDEXED_COUNT_EXT:
        str = "VK_INDIRECT_COMMANDS_TOKEN_TYPE_DRAW_INDEXED_COUNT_EXT";
        break;
    case VK_INDIRECT_COMMANDS_TOKEN_TYPE_DRAW_COUNT_EXT: str = "VK_INDIRECT_COMMANDS_TOKEN_TYPE_DRAW_COUNT_EXT"; break;
    case VK_INDIRECT_COMMANDS_TOKEN_TYPE_DISPATCH_EXT: str = "VK_INDIRECT_COMMANDS_TOKEN_TYPE_DISPATCH_EXT"; break;
    case VK_INDIRECT_COMMANDS_TOKEN_TYPE_DRAW_MESH_TASKS_NV_EXT:
        str = "VK_INDIRECT_COMMANDS_TOKEN_TYPE_DRAW_MESH_TASKS_NV_EXT";
        break;
    case VK_INDIRECT_COMMANDS_TOKEN_TYPE_DRAW_MESH_TASKS_COUNT_NV_EXT:
        str = "VK_INDIRECT_COMMANDS_TOKEN_TYPE_DRAW_MESH_TASKS_COUNT_NV_EXT";
        break;
    case VK_INDIRECT_COMMANDS_TOKEN_TYPE_DRAW_MESH_TASKS_EXT:
        str = "VK_INDIRECT_COMMANDS_TOKEN_TYPE_DRAW_MESH_TASKS_EXT";
        break;
    case VK_INDIRECT_COMMANDS_TOKEN_TYPE_DRAW_MESH_TASKS_COUNT_EXT:
        str = "VK_INDIRECT_COMMANDS_TOKEN_TYPE_DRAW_MESH_TASKS_COUNT_EXT";
        break;
    case VK_INDIRECT_COMMANDS_TOKEN_TYPE_TRACE_RAYS2_EXT: str = "VK_INDIRECT_COMMANDS_TOKEN_TYPE_TRACE_RAYS2_EXT"; break;
    default: break;
    }
    return str;
}
...
String On_Str_VkAccessFlags([[maybe_unused]] VkAccessFlags f) {
    String str = "|";
    ...
    if (f & VK_ACCESS_COMMAND_PREPROCESS_READ_BIT_EXT) {
        str += "COMMAND_PREPROCESS_READ|";
    }
    if (f & VK_ACCESS_COMMAND_PREPROCESS_WRITE_BIT_EXT) {
        str += "COMMAND_PREPROCESS_WRITE|";
    }
    return str;
}

String On_Str_VkImageAspectFlags([[maybe_unused]] VkImageAspectFlags f) {
    String str = "|";
...
String On_Str_VkFormatFeatureFlags([[maybe_unused]] VkFormatFeatureFlags f) {
    String str = "|";
...
String On_Str_VkImageCreateFlags([[maybe_unused]] VkImageCreateFlags f) {
    String str = "|";
    ...
    if (f & VK_IMAGE_CREATE_FRAGMENT_DENSITY_MAP_OFFSET_BIT_EXT) {
        str += "FRAGMENT_DENSITY_MAP_OFFSET|";
    }
    return str;
}

String On_Str_VkSampleCountFlags([[maybe_unused]] VkSampleCountFlags f) {
    String str = "|";
...
String On_Str_VkImageUsageFlags([[maybe_unused]] VkImageUsageFlags f) {
    String str = "|";
    ...
    if (f & VK_IMAGE_USAGE_HOST_TRANSFER_BIT) {
        str += "HOST_TRANSFER|";
    }
    ...
    if (f & VK_IMAGE_USAGE_TENSOR_ALIASING_BIT_ARM) {
        str += "TENSOR_ALIASING_BIT_ARM|";
    }
    if (f & VK_IMAGE_USAGE_TILE_MEMORY_BIT_QCOM) {
        str += "TILE_MEMORY|";
    }
    if (f & VK_IMAGE_USAGE_VIDEO_ENCODE_QUANTIZATION_DELTA_MAP_BIT_KHR) {
        str += "VIDEO_ENCODE_QUANTIZATION_DELTA_MAP|";
    }
    if (f & VK_IMAGE_USAGE_VIDEO_ENCODE_EMPHASIS_MAP_BIT_KHR) {
        str += "VIDEO_ENCODE_EMPHASIS_MAP|";
    }
    return str;
}

String On_Str_VkInstanceCreateFlags([[maybe_unused]] VkInstanceCreateFlags f) {
    String str = "|";
...
String On_Str_VkMemoryHeapFlags([[maybe_unused]] VkMemoryHeapFlags f) {
    String str = "|";
    ...
    if (f & VK_MEMORY_HEAP_TILE_MEMORY_BIT_QCOM) {
        str += "TILE_MEMORY|";
    }
    return str;
}

String On_Str_VkMemoryPropertyFlags([[maybe_unused]] VkMemoryPropertyFlags f) {
    String str = "|";
...
String On_Str_VkQueueFlags([[maybe_unused]] VkQueueFlags f) {
    String str = "|";
    ...
    if (f & VK_QUEUE_DATA_GRAPH_BIT_ARM) {
        str += "DATA_GRAPH_BIT_ARM|";
    }
    return str;
}

String On_Str_VkDeviceQueueCreateFlags([[maybe_unused]] VkDeviceQueueCreateFlags f) {
    String str = "|";
...
String On_Str_VkPipelineStageFlags([[maybe_unused]] VkPipelineStageFlags f) {
    String str = "|";
    ...
    if (f & VK_PIPELINE_STAGE_COMMAND_PREPROCESS_BIT_EXT) {
        str += "COMMAND_PREPROCESS|";
    }
    return str;
}

String On_Str_VkMemoryMapFlags([[maybe_unused]] VkMemoryMapFlags f) {
    String str = "|";
...
String On_Str_VkSparseMemoryBindFlags([[maybe_unused]] VkSparseMemoryBindFlags f) {
    String str = "|";
...
String On_Str_VkSparseImageFormatFlags([[maybe_unused]] VkSparseImageFormatFlags f) {
    String str = "|";
...
String On_Str_VkFenceCreateFlags([[maybe_unused]] VkFenceCreateFlags f) {
    String str = "|";
...
String On_Str_VkEventCreateFlags([[maybe_unused]] VkEventCreateFlags f) {
    String str = "|";
...
String On_Str_VkQueryPipelineStatisticFlags([[maybe_unused]] VkQueryPipelineStatisticFlags f) {
    String str = "|";
...
String On_Str_VkQueryPoolCreateFlags([[maybe_unused]] VkQueryPoolCreateFlags f) {
    String str = "|";
    if (f & VK_QUERY_POOL_CREATE_RESET_BIT_KHR) {
        str += "RESET|";
    }
    return str;
}

String On_Str_VkQueryResultFlags([[maybe_unused]] VkQueryResultFlags f) {
    String str = "|";
...
String On_Str_VkBufferCreateFlags([[maybe_unused]] VkBufferCreateFlags f) {
    String str = "|";
...
String On_Str_VkBufferUsageFlags([[maybe_unused]] VkBufferUsageFlags f) {
    String str = "|";
    ...
    if (f & VK_BUFFER_USAGE_TILE_MEMORY_BIT_QCOM) {
        str += "TILE_MEMORY|";
    }
    return str;
}

String On_Str_VkImageViewCreateFlags([[maybe_unused]] VkImageViewCreateFlags f) {
    String str = "|";
...
String On_Str_VkPipelineCacheCreateFlags([[maybe_unused]] VkPipelineCacheCreateFlags f) {
    String str = "|";
    if (f & VK_PIPELINE_CACHE_CREATE_EXTERNALLY_SYNCHRONIZED_BIT) {
        str += "EXTERNALLY_SYNCHRONIZED|";
    }
    if (f & VK_PIPELINE_CACHE_CREATE_INTERNALLY_SYNCHRONIZED_MERGE_BIT_KHR) {
        str += "INTERNALLY_SYNCHRONIZED_MERGE|";
    }
    return str;
}

String On_Str_VkColorComponentFlags([[maybe_unused]] VkColorComponentFlags f) {
    String str = "|";
...
String On_Str_VkPipelineCreateFlags([[maybe_unused]] VkPipelineCreateFlags f) {
    String str = "|";
    ...
    if (f & VK_PIPELINE_CREATE_NO_PROTECTED_ACCESS_BIT) {
        str += "NO_PROTECTED_ACCESS|";
    }
    if (f & VK_PIPELINE_CREATE_PROTECTED_ACCESS_ONLY_BIT) {
...
String On_Str_VkPipelineShaderStageCreateFlags([[maybe_unused]] VkPipelineShaderStageCreateFlags f) {
    String str = "|";
...
String On_Str_VkShaderStageFlags([[maybe_unused]] VkShaderStageFlags f) {
    String str = "|";
...
String On_Str_VkCullModeFlags([[maybe_unused]] VkCullModeFlags f) {
    String str = "|";
...
String On_Str_VkPipelineDepthStencilStateCreateFlags([[maybe_unused]] VkPipelineDepthStencilStateCreateFlags f) {
    String str = "|";
...
String On_Str_VkPipelineColorBlendStateCreateFlags([[maybe_unused]] VkPipelineColorBlendStateCreateFlags f) {
    String str = "|";
...
String On_Str_VkPipelineLayoutCreateFlags([[maybe_unused]] VkPipelineLayoutCreateFlags f) {
    String str = "|";
...
String On_Str_VkSamplerCreateFlags([[maybe_unused]] VkSamplerCreateFlags f) {
    String str = "|";
...
String On_Str_VkDescriptorPoolCreateFlags([[maybe_unused]] VkDescriptorPoolCreateFlags f) {
    String str = "|";
...
String On_Str_VkDescriptorSetLayoutCreateFlags([[maybe_unused]] VkDescriptorSetLayoutCreateFlags f) {
    String str = "|";
    if (f & VK_DESCRIPTOR_SET_LAYOUT_CREATE_UPDATE_AFTER_BIND_POOL_BIT) {
        str += "UPDATE_AFTER_BIND_POOL|";
    }
    if (f & VK_DESCRIPTOR_SET_LAYOUT_CREATE_PUSH_DESCRIPTOR_BIT) {
        str += "PUSH_DESCRIPTOR|";
    }
...
String On_Str_VkAttachmentDescriptionFlags([[maybe_unused]] VkAttachmentDescriptionFlags f) {
    String str = "|";
...
String On_Str_VkDependencyFlags([[maybe_unused]] VkDependencyFlags f) {
    String str = "|";
    ...
    if (f & VK_DEPENDENCY_QUEUE_FAMILY_OWNERSHIP_TRANSFER_USE_ALL_STAGES_BIT_KHR) {
        str += "QUEUE_FAMILY_OWNERSHIP_TRANSFER_USE_ALL_STAGES|";
    }
    if (f & VK_DEPENDENCY_ASYMMETRIC_EVENT_BIT_KHR) {
        str += "ASYMMETRIC_EVENT|";
    }
    return str;
}

String On_Str_VkFramebufferCreateFlags([[maybe_unused]] VkFramebufferCreateFlags f) {
    String str = "|";
...
String On_Str_VkRenderPassCreateFlags([[maybe_unused]] VkRenderPassCreateFlags f) {
    String str = "|";
    if (f & VK_RENDER_PASS_CREATE_TRANSFORM_BIT_QCOM) {
        str += "TRANSFORM|";
    }
    if (f & VK_RENDER_PASS_CREATE_PER_LAYER_FRAGMENT_DENSITY_BIT_VALVE) {
        str += "PER_LAYER_FRAGMENT_DENSITY_BIT_VALVE|";
    }
    return str;
}

String On_Str_VkSubpassDescriptionFlags([[maybe_unused]] VkSubpassDescriptionFlags f) {
    String str = "|";
    ...
    if (f & VK_SUBPASS_DESCRIPTION_TILE_SHADING_APRON_BIT_QCOM) {
        str += "TILE_SHADING_APRON|";
    }
...
String On_Str_VkCommandPoolCreateFlags([[maybe_unused]] VkCommandPoolCreateFlags f) {
    String str = "|";
...
String On_Str_VkCommandPoolResetFlags([[maybe_unused]] VkCommandPoolResetFlags f) {
    String str = "|";
...
String On_Str_VkCommandBufferUsageFlags([[maybe_unused]] VkCommandBufferUsageFlags f) {
    String str = "|";
...
String On_Str_VkQueryControlFlags([[maybe_unused]] VkQueryControlFlags f) {
    String str = "|";
...
String On_Str_VkCommandBufferResetFlags([[maybe_unused]] VkCommandBufferResetFlags f) {
    String str = "|";
...
String On_Str_VkStencilFaceFlags([[maybe_unused]] VkStencilFaceFlags f) {
    String str = "|";
...
String On_Str_VkSubgroupFeatureFlags([[maybe_unused]] VkSubgroupFeatureFlags f) {
    String str = "|";
    ...
    if (f & VK_SUBGROUP_FEATURE_ROTATE_BIT) {
        str += "ROTATE|";
    }
    if (f & VK_SUBGROUP_FEATURE_ROTATE_CLUSTERED_BIT) {
...
String On_Str_VkPeerMemoryFeatureFlags([[maybe_unused]] VkPeerMemoryFeatureFlags f) {
    String str = "|";
...
String On_Str_VkMemoryAllocateFlags([[maybe_unused]] VkMemoryAllocateFlags f) {
    String str = "|";
    ...
    if (f & VK_MEMORY_ALLOCATE_ZERO_INITIALIZE_BIT_EXT) {
        str += "ZERO_INITIALIZE|";
    }
    return str;
}

String On_Str_VkExternalMemoryHandleTypeFlags([[maybe_unused]] VkExternalMemoryHandleTypeFlags f) {
    String str = "|";
    ...
    if (f & VK_EXTERNAL_MEMORY_HANDLE_TYPE_MTLBUFFER_BIT_EXT) {
        str += "MTLBUFFER|";
    }
    if (f & VK_EXTERNAL_MEMORY_HANDLE_TYPE_MTLTEXTURE_BIT_EXT) {
        str += "MTLTEXTURE|";
    }
    if (f & VK_EXTERNAL_MEMORY_HANDLE_TYPE_MTLHEAP_BIT_EXT) {
        str += "MTLHEAP|";
    }
    return str;
}

String On_Str_VkExternalMemoryFeatureFlags([[maybe_unused]] VkExternalMemoryFeatureFlags f) {
    String str = "|";
...
String On_Str_VkExternalFenceHandleTypeFlags([[maybe_unused]] VkExternalFenceHandleTypeFlags f) {
    String str = "|";
...
String On_Str_VkExternalFenceFeatureFlags([[maybe_unused]] VkExternalFenceFeatureFlags f) {
    String str = "|";
...
String On_Str_VkFenceImportFlags([[maybe_unused]] VkFenceImportFlags f) {
    String str = "|";
...
String On_Str_VkSemaphoreImportFlags([[maybe_unused]] VkSemaphoreImportFlags f) {
    String str = "|";
...
String On_Str_VkExternalSemaphoreHandleTypeFlags([[maybe_unused]] VkExternalSemaphoreHandleTypeFlags f) {
    String str = "|";
...
String On_Str_VkExternalSemaphoreFeatureFlags([[maybe_unused]] VkExternalSemaphoreFeatureFlags f) {
    String str = "|";
...
String On_Str_VkResolveModeFlags([[maybe_unused]] VkResolveModeFlags f) {
    String str = "|";
    ...
    if (f & VK_RESOLVE_MODE_EXTERNAL_FORMAT_DOWNSAMPLE_BIT_ANDROID) {
        str += "EXTERNAL_FORMAT_DOWNSAMPLE_BIT_ANDROID|";
    }
    return str;
}

String On_Str_VkDescriptorBindingFlags([[maybe_unused]] VkDescriptorBindingFlags f) {
    String str = "|";
...
String On_Str_VkSemaphoreWaitFlags([[maybe_unused]] VkSemaphoreWaitFlags f) {
    String str = "|";
...
String On_Str_VkPipelineCreationFeedbackFlags([[maybe_unused]] VkPipelineCreationFeedbackFlags f) {
    String str = "|";
...
String On_Str_VkToolPurposeFlags([[maybe_unused]] VkToolPurposeFlags f) {
    String str = "|";
...
String On_Str_VkPipelineStageFlags2([[maybe_unused]] VkPipelineStageFlags2 f) {
    String str = "|";
    ...
    if (f & VK_PIPELINE_STAGE_2_COMMAND_PREPROCESS_BIT_EXT) {
    ...
    if (f & VK_PIPELINE_STAGE_2_CONVERT_COOPERATIVE_VECTOR_MATRIX_BIT_NV) {
        str += "2_CONVERT_COOPERATIVE_VECTOR_MATRIX|";
    }
    if (f & VK_PIPELINE_STAGE_2_DATA_GRAPH_BIT_ARM) {
        str += "2_DATA_GRAPH_BIT_ARM|";
    }
    return str;
}

String On_Str_VkAccessFlags2([[maybe_unused]] VkAccessFlags2 f) {
    String str = "|";
    ...
    if (f & VK_ACCESS_2_SHADER_TILE_ATTACHMENT_READ_BIT_QCOM) {
        str += "2_SHADER_TILE_ATTACHMENT_READ|";
    }
    if (f & VK_ACCESS_2_SHADER_TILE_ATTACHMENT_WRITE_BIT_QCOM) {
        str += "2_SHADER_TILE_ATTACHMENT_WRITE|";
    }
    ...
    if (f & VK_ACCESS_2_COMMAND_PREPROCESS_READ_BIT_EXT) {
        str += "2_COMMAND_PREPROCESS_READ|";
    }
    if (f & VK_ACCESS_2_COMMAND_PREPROCESS_WRITE_BIT_EXT) {
    ...
    if (f & VK_ACCESS_2_DATA_GRAPH_READ_BIT_ARM) {
        str += "2_DATA_GRAPH_READ_BIT_ARM|";
    }
    if (f & VK_ACCESS_2_DATA_GRAPH_WRITE_BIT_ARM) {
        str += "2_DATA_GRAPH_WRITE_BIT_ARM|";
    }
    return str;
}

String On_Str_VkSubmitFlags([[maybe_unused]] VkSubmitFlags f) {
    String str = "|";
...
String On_Str_VkRenderingFlags([[maybe_unused]] VkRenderingFlags f) {
    String str = "|";
    ...
    if (f & VK_RENDERING_CONTENTS_INLINE_BIT_KHR) {
        str += "CONTENTS_INLINE|";
    }
    if (f & VK_RENDERING_PER_LAYER_FRAGMENT_DENSITY_BIT_VALVE) {
        str += "PER_LAYER_FRAGMENT_DENSITY_BIT_VALVE|";
    }
    return str;
}

String On_Str_VkFormatFeatureFlags2([[maybe_unused]] VkFormatFeatureFlags2 f) {
    String str = "|";
    ...
    if (f & VK_FORMAT_FEATURE_2_HOST_IMAGE_TRANSFER_BIT) {
    ...
    if (f & VK_FORMAT_FEATURE_2_ACCELERATION_STRUCTURE_RADIUS_BUFFER_BIT_NV) {
        str += "2_ACCELERATION_STRUCTURE_RADIUS_BUFFER|";
    }
    ...
    if (f & VK_FORMAT_FEATURE_2_TENSOR_SHADER_BIT_ARM) {
        str += "2_TENSOR_SHADER_BIT_ARM|";
    }
    if (f & VK_FORMAT_FEATURE_2_TENSOR_IMAGE_ALIASING_BIT_ARM) {
        str += "2_TENSOR_IMAGE_ALIASING_BIT_ARM|";
    }
    ...
    if (f & VK_FORMAT_FEATURE_2_TENSOR_DATA_GRAPH_BIT_ARM) {
        str += "2_TENSOR_DATA_GRAPH_BIT_ARM|";
    }
    if (f & VK_FORMAT_FEATURE_2_VIDEO_ENCODE_QUANTIZATION_DELTA_MAP_BIT_KHR) {
        str += "2_VIDEO_ENCODE_QUANTIZATION_DELTA_MAP|";
    }
    if (f & VK_FORMAT_FEATURE_2_VIDEO_ENCODE_EMPHASIS_MAP_BIT_KHR) {
        str += "2_VIDEO_ENCODE_EMPHASIS_MAP|";
    }
    return str;
}

String On_Str_VkMemoryUnmapFlags([[maybe_unused]] VkMemoryUnmapFlags f) {
    String str = "|";
...
String On_Str_VkPipelineCreateFlags2([[maybe_unused]] VkPipelineCreateFlags2 f) {
    String str = "|";
    if (f & VK_PIPELINE_CREATE_2_DISABLE_OPTIMIZATION_BIT) {
        str += "2_DISABLE_OPTIMIZATION|";
    }
    if (f & VK_PIPELINE_CREATE_2_ALLOW_DERIVATIVES_BIT) {
        str += "2_ALLOW_DERIVATIVES|";
    }
    if (f & VK_PIPELINE_CREATE_2_DERIVATIVE_BIT) {
        str += "2_DERIVATIVE|";
    }
    if (f & VK_PIPELINE_CREATE_2_VIEW_INDEX_FROM_DEVICE_INDEX_BIT) {
        str += "2_VIEW_INDEX_FROM_DEVICE_INDEX|";
    }
    if (f & VK_PIPELINE_CREATE_2_DISPATCH_BASE_BIT) {
        str += "2_DISPATCH_BASE|";
    }
    if (f & VK_PIPELINE_CREATE_2_FAIL_ON_PIPELINE_COMPILE_REQUIRED_BIT) {
        str += "2_FAIL_ON_PIPELINE_COMPILE_REQUIRED|";
    }
    if (f & VK_PIPELINE_CREATE_2_EARLY_RETURN_ON_FAILURE_BIT) {
        str += "2_EARLY_RETURN_ON_FAILURE|";
    }
    if (f & VK_PIPELINE_CREATE_2_NO_PROTECTED_ACCESS_BIT) {
        str += "2_NO_PROTECTED_ACCESS|";
    }
    if (f & VK_PIPELINE_CREATE_2_PROTECTED_ACCESS_ONLY_BIT) {
        str += "2_PROTECTED_ACCESS_ONLY|";
    }
#ifdef VK_ENABLE_BETA_EXTENSIONS
    if (f & VK_PIPELINE_CREATE_2_EXECUTION_GRAPH_BIT_AMDX) {
        str += "2_EXECUTION_GRAPH|";
    }
#endif // VK_ENABLE_BETA_EXTENSIONS
    if (f & VK_PIPELINE_CREATE_2_RAY_TRACING_ALLOW_SPHERES_AND_LINEAR_SWEPT_SPHERES_BIT_NV) {
        str += "2_RAY_TRACING_ALLOW_SPHERES_AND_LINEAR_SWEPT_SPHERES|";
    }
    if (f & VK_PIPELINE_CREATE_2_ENABLE_LEGACY_DITHERING_BIT_EXT) {
        str += "2_ENABLE_LEGACY_DITHERING|";
    }
    if (f & VK_PIPELINE_CREATE_2_DEFER_COMPILE_BIT_NV) {
        str += "2_DEFER_COMPILE|";
    }
    if (f & VK_PIPELINE_CREATE_2_CAPTURE_STATISTICS_BIT_KHR) {
        str += "2_CAPTURE_STATISTICS|";
    }
    if (f & VK_PIPELINE_CREATE_2_CAPTURE_INTERNAL_REPRESENTATIONS_BIT_KHR) {
        str += "2_CAPTURE_INTERNAL_REPRESENTATIONS|";
    }
    if (f & VK_PIPELINE_CREATE_2_LINK_TIME_OPTIMIZATION_BIT_EXT) {
        str += "2_LINK_TIME_OPTIMIZATION|";
    }
    if (f & VK_PIPELINE_CREATE_2_RETAIN_LINK_TIME_OPTIMIZATION_INFO_BIT_EXT) {
        str += "2_RETAIN_LINK_TIME_OPTIMIZATION_INFO|";
    }
    if (f & VK_PIPELINE_CREATE_2_LIBRARY_BIT_KHR) {
        str += "2_LIBRARY|";
    }
    if (f & VK_PIPELINE_CREATE_2_RAY_TRACING_SKIP_TRIANGLES_BIT_KHR) {
        str += "2_RAY_TRACING_SKIP_TRIANGLES|";
    }
    if (f & VK_PIPELINE_CREATE_2_RAY_TRACING_SKIP_AABBS_BIT_KHR) {
        str += "2_RAY_TRACING_SKIP_AABBS|";
    }
    if (f & VK_PIPELINE_CREATE_2_RAY_TRACING_NO_NULL_ANY_HIT_SHADERS_BIT_KHR) {
        str += "2_RAY_TRACING_NO_NULL_ANY_HIT_SHADERS|";
    }
    if (f & VK_PIPELINE_CREATE_2_RAY_TRACING_NO_NULL_CLOSEST_HIT_SHADERS_BIT_KHR) {
        str += "2_RAY_TRACING_NO_NULL_CLOSEST_HIT_SHADERS|";
    }
    if (f & VK_PIPELINE_CREATE_2_RAY_TRACING_NO_NULL_MISS_SHADERS_BIT_KHR) {
        str += "2_RAY_TRACING_NO_NULL_MISS_SHADERS|";
    }
    if (f & VK_PIPELINE_CREATE_2_RAY_TRACING_NO_NULL_INTERSECTION_SHADERS_BIT_KHR) {
        str += "2_RAY_TRACING_NO_NULL_INTERSECTION_SHADERS|";
    }
    if (f & VK_PIPELINE_CREATE_2_RAY_TRACING_SHADER_GROUP_HANDLE_CAPTURE_REPLAY_BIT_KHR) {
        str += "2_RAY_TRACING_SHADER_GROUP_HANDLE_CAPTURE_REPLAY|";
    }
    if (f & VK_PIPELINE_CREATE_2_INDIRECT_BINDABLE_BIT_NV) {
        str += "2_INDIRECT_BINDABLE|";
    }
    if (f & VK_PIPELINE_CREATE_2_RAY_TRACING_ALLOW_MOTION_BIT_NV) {
        str += "2_RAY_TRACING_ALLOW_MOTION|";
    }
    if (f & VK_PIPELINE_CREATE_2_RENDERING_FRAGMENT_SHADING_RATE_ATTACHMENT_BIT_KHR) {
        str += "2_RENDERING_FRAGMENT_SHADING_RATE_ATTACHMENT|";
    }
    if (f & VK_PIPELINE_CREATE_2_RENDERING_FRAGMENT_DENSITY_MAP_ATTACHMENT_BIT_EXT) {
        str += "2_RENDERING_FRAGMENT_DENSITY_MAP_ATTACHMENT|";
    }
    if (f & VK_PIPELINE_CREATE_2_RAY_TRACING_OPACITY_MICROMAP_BIT_EXT) {
        str += "2_RAY_TRACING_OPACITY_MICROMAP|";
    }
    if (f & VK_PIPELINE_CREATE_2_COLOR_ATTACHMENT_FEEDBACK_LOOP_BIT_EXT) {
        str += "2_COLOR_ATTACHMENT_FEEDBACK_LOOP|";
    }
    if (f & VK_PIPELINE_CREATE_2_DEPTH_STENCIL_ATTACHMENT_FEEDBACK_LOOP_BIT_EXT) {
        str += "2_DEPTH_STENCIL_ATTACHMENT_FEEDBACK_LOOP|";
    }
    if (f & VK_PIPELINE_CREATE_2_RAY_TRACING_DISPLACEMENT_MICROMAP_BIT_NV) {
        str += "2_RAY_TRACING_DISPLACEMENT_MICROMAP|";
    }
    if (f & VK_PIPELINE_CREATE_2_DESCRIPTOR_BUFFER_BIT_EXT) {
        str += "2_DESCRIPTOR_BUFFER|";
    }
    if (f & VK_PIPELINE_CREATE_2_DISALLOW_OPACITY_MICROMAP_BIT_ARM) {
        str += "2_DISALLOW_OPACITY_MICROMAP_BIT_ARM|";
    }
    if (f & VK_PIPELINE_CREATE_2_CAPTURE_DATA_BIT_KHR) {
        str += "2_CAPTURE_DATA|";
    }
    if (f & VK_PIPELINE_CREATE_2_INDIRECT_BINDABLE_BIT_EXT) {
        str += "2_INDIRECT_BINDABLE|";
    }
    if (f & VK_PIPELINE_CREATE_2_PER_LAYER_FRAGMENT_DENSITY_BIT_VALVE) {
        str += "2_PER_LAYER_FRAGMENT_DENSITY_BIT_VALVE|";
    }
    return str;
}

String On_Str_VkBufferUsageFlags2([[maybe_unused]] VkBufferUsageFlags2 f) {
    String str = "|";
    if (f & VK_BUFFER_USAGE_2_TRANSFER_SRC_BIT) {
        str += "2_TRANSFER_SRC|";
    }
    if (f & VK_BUFFER_USAGE_2_TRANSFER_DST_BIT) {
        str += "2_TRANSFER_DST|";
    }
    if (f & VK_BUFFER_USAGE_2_UNIFORM_TEXEL_BUFFER_BIT) {
        str += "2_UNIFORM_TEXEL_BUFFER|";
    }
    if (f & VK_BUFFER_USAGE_2_STORAGE_TEXEL_BUFFER_BIT) {
        str += "2_STORAGE_TEXEL_BUFFER|";
    }
    if (f & VK_BUFFER_USAGE_2_UNIFORM_BUFFER_BIT) {
        str += "2_UNIFORM_BUFFER|";
    }
    if (f & VK_BUFFER_USAGE_2_STORAGE_BUFFER_BIT) {
        str += "2_STORAGE_BUFFER|";
    }
    if (f & VK_BUFFER_USAGE_2_INDEX_BUFFER_BIT) {
        str += "2_INDEX_BUFFER|";
    }
    if (f & VK_BUFFER_USAGE_2_VERTEX_BUFFER_BIT) {
        str += "2_VERTEX_BUFFER|";
    }
    if (f & VK_BUFFER_USAGE_2_INDIRECT_BUFFER_BIT) {
        str += "2_INDIRECT_BUFFER|";
    }
    if (f & VK_BUFFER_USAGE_2_SHADER_DEVICE_ADDRESS_BIT) {
        str += "2_SHADER_DEVICE_ADDRESS|";
    }
#ifdef VK_ENABLE_BETA_EXTENSIONS
    if (f & VK_BUFFER_USAGE_2_EXECUTION_GRAPH_SCRATCH_BIT_AMDX) {
        str += "2_EXECUTION_GRAPH_SCRATCH|";
    }
#endif // VK_ENABLE_BETA_EXTENSIONS
    ...
    if (f & VK_BUFFER_USAGE_2_SHADER_BINDING_TABLE_BIT_KHR) {
        str += "2_SHADER_BINDING_TABLE|";
    }
    if (f & VK_BUFFER_USAGE_2_TRANSFORM_FEEDBACK_BUFFER_BIT_EXT) {
        str += "2_TRANSFORM_FEEDBACK_BUFFER|";
    }
    if (f & VK_BUFFER_USAGE_2_TRANSFORM_FEEDBACK_COUNTER_BUFFER_BIT_EXT) {
        str += "2_TRANSFORM_FEEDBACK_COUNTER_BUFFER|";
    }
    if (f & VK_BUFFER_USAGE_2_VIDEO_DECODE_SRC_BIT_KHR) {
        str += "2_VIDEO_DECODE_SRC|";
    }
    if (f & VK_BUFFER_USAGE_2_VIDEO_DECODE_DST_BIT_KHR) {
        str += "2_VIDEO_DECODE_DST|";
    }
    if (f & VK_BUFFER_USAGE_2_VIDEO_ENCODE_DST_BIT_KHR) {
        str += "2_VIDEO_ENCODE_DST|";
    }
    if (f & VK_BUFFER_USAGE_2_VIDEO_ENCODE_SRC_BIT_KHR) {
        str += "2_VIDEO_ENCODE_SRC|";
    }
    if (f & VK_BUFFER_USAGE_2_ACCELERATION_STRUCTURE_BUILD_INPUT_READ_ONLY_BIT_KHR) {
        str += "2_ACCELERATION_STRUCTURE_BUILD_INPUT_READ_ONLY|";
    }
    if (f & VK_BUFFER_USAGE_2_ACCELERATION_STRUCTURE_STORAGE_BIT_KHR) {
        str += "2_ACCELERATION_STRUCTURE_STORAGE|";
    }
    if (f & VK_BUFFER_USAGE_2_SAMPLER_DESCRIPTOR_BUFFER_BIT_EXT) {
        str += "2_SAMPLER_DESCRIPTOR_BUFFER|";
    }
    if (f & VK_BUFFER_USAGE_2_RESOURCE_DESCRIPTOR_BUFFER_BIT_EXT) {
        str += "2_RESOURCE_DESCRIPTOR_BUFFER|";
    }
    if (f & VK_BUFFER_USAGE_2_PUSH_DESCRIPTORS_DESCRIPTOR_BUFFER_BIT_EXT) {
        str += "2_PUSH_DESCRIPTORS_DESCRIPTOR_BUFFER|";
    }
    if (f & VK_BUFFER_USAGE_2_MICROMAP_BUILD_INPUT_READ_ONLY_BIT_EXT) {
        str += "2_MICROMAP_BUILD_INPUT_READ_ONLY|";
    }
    if (f & VK_BUFFER_USAGE_2_MICROMAP_STORAGE_BIT_EXT) {
        str += "2_MICROMAP_STORAGE|";
    }
    if (f & VK_BUFFER_USAGE_2_DATA_GRAPH_FOREIGN_DESCRIPTOR_BIT_ARM) {
        str += "2_DATA_GRAPH_FOREIGN_DESCRIPTOR_BIT_ARM|";
    }
    if (f & VK_BUFFER_USAGE_2_TILE_MEMORY_BIT_QCOM) {
        str += "2_TILE_MEMORY|";
    }
    if (f & VK_BUFFER_USAGE_2_PREPROCESS_BUFFER_BIT_EXT) {
        str += "2_PREPROCESS_BUFFER|";
    }
    return str;
}

String On_Str_VkHostImageCopyFlags([[maybe_unused]] VkHostImageCopyFlags f) {
    String str = "|";
    if (f & VK_HOST_IMAGE_COPY_MEMCPY_BIT) {
        str += "MEMCPY|";
    }
    return str;
}

String On_Str_VkSurfaceTransformFlagsKHR([[maybe_unused]] VkSurfaceTransformFlagsKHR f) {
    String str = "|";
...
String On_Str_VkCompositeAlphaFlagsKHR([[maybe_unused]] VkCompositeAlphaFlagsKHR f) {
    String str = "|";
...
String On_Str_VkSwapchainCreateFlagsKHR([[maybe_unused]] VkSwapchainCreateFlagsKHR f) {
    String str = "|";
    ...
    if (f & VK_SWAPCHAIN_CREATE_PRESENT_ID_2_BIT_KHR) {
        str += "PRESENT_ID_2|";
    }
    if (f & VK_SWAPCHAIN_CREATE_PRESENT_WAIT_2_BIT_KHR) {
        str += "PRESENT_WAIT_2|";
    }
    if (f & VK_SWAPCHAIN_CREATE_DEFERRED_MEMORY_ALLOCATION_BIT_KHR) {
        str += "DEFERRED_MEMORY_ALLOCATION|";
    }
    return str;
}

String On_Str_VkDeviceGroupPresentModeFlagsKHR([[maybe_unused]] VkDeviceGroupPresentModeFlagsKHR f) {
    String str = "|";
...
String On_Str_VkDisplayPlaneAlphaFlagsKHR([[maybe_unused]] VkDisplayPlaneAlphaFlagsKHR f) {
    String str = "|";
...
String On_Str_VkVideoCodecOperationFlagsKHR([[maybe_unused]] VkVideoCodecOperationFlagsKHR f) {
    String str = "|";
    ...
    if (f & VK_VIDEO_CODEC_OPERATION_ENCODE_AV1_BIT_KHR) {
        str += "ENCODE_AV1|";
    }
    if (f & VK_VIDEO_CODEC_OPERATION_DECODE_VP9_BIT_KHR) {
        str += "DECODE_VP9|";
    }
    return str;
}

String On_Str_VkVideoChromaSubsamplingFlagsKHR([[maybe_unused]] VkVideoChromaSubsamplingFlagsKHR f) {
    String str = "|";
...
String On_Str_VkVideoComponentBitDepthFlagsKHR([[maybe_unused]] VkVideoComponentBitDepthFlagsKHR f) {
    String str = "|";
...
String On_Str_VkVideoCapabilityFlagsKHR([[maybe_unused]] VkVideoCapabilityFlagsKHR f) {
    String str = "|";
...
String On_Str_VkVideoSessionCreateFlagsKHR([[maybe_unused]] VkVideoSessionCreateFlagsKHR f) {
    String str = "|";
    ...
    if (f & VK_VIDEO_SESSION_CREATE_ALLOW_ENCODE_QUANTIZATION_DELTA_MAP_BIT_KHR) {
        str += "ALLOW_ENCODE_QUANTIZATION_DELTA_MAP|";
    }
    if (f & VK_VIDEO_SESSION_CREATE_ALLOW_ENCODE_EMPHASIS_MAP_BIT_KHR) {
        str += "ALLOW_ENCODE_EMPHASIS_MAP|";
    }
    if (f & VK_VIDEO_SESSION_CREATE_INLINE_SESSION_PARAMETERS_BIT_KHR) {
        str += "INLINE_SESSION_PARAMETERS|";
    }
    return str;
}

String On_Str_VkVideoSessionParametersCreateFlagsKHR([[maybe_unused]] VkVideoSessionParametersCreateFlagsKHR f) {
    String str = "|";
    if (f & VK_VIDEO_SESSION_PARAMETERS_CREATE_QUANTIZATION_MAP_COMPATIBLE_BIT_KHR) {
        str += "QUANTIZATION_MAP_COMPATIBLE|";
    }
    return str;
}

String On_Str_VkVideoCodingControlFlagsKHR([[maybe_unused]] VkVideoCodingControlFlagsKHR f) {
    String str = "|";
...
String On_Str_VkVideoDecodeCapabilityFlagsKHR([[maybe_unused]] VkVideoDecodeCapabilityFlagsKHR f) {
    String str = "|";
...
String On_Str_VkVideoDecodeUsageFlagsKHR([[maybe_unused]] VkVideoDecodeUsageFlagsKHR f) {
    String str = "|";
...
String On_Str_VkVideoEncodeH264CapabilityFlagsKHR([[maybe_unused]] VkVideoEncodeH264CapabilityFlagsKHR f) {
    String str = "|";
    ...
    if (f & VK_VIDEO_ENCODE_H264_CAPABILITY_B_PICTURE_INTRA_REFRESH_BIT_KHR) {
        str += "B_PICTURE_INTRA_REFRESH|";
    }
    if (f & VK_VIDEO_ENCODE_H264_CAPABILITY_MB_QP_DIFF_WRAPAROUND_BIT_KHR) {
        str += "MB_QP_DIFF_WRAPAROUND|";
    }
    return str;
}

String On_Str_VkVideoEncodeH264StdFlagsKHR([[maybe_unused]] VkVideoEncodeH264StdFlagsKHR f) {
    String str = "|";
...
String On_Str_VkVideoEncodeH264RateControlFlagsKHR([[maybe_unused]] VkVideoEncodeH264RateControlFlagsKHR f) {
    String str = "|";
...
String On_Str_VkVideoEncodeH265CapabilityFlagsKHR([[maybe_unused]] VkVideoEncodeH265CapabilityFlagsKHR f) {
    String str = "|";
    ...
    if (f & VK_VIDEO_ENCODE_H265_CAPABILITY_B_PICTURE_INTRA_REFRESH_BIT_KHR) {
        str += "B_PICTURE_INTRA_REFRESH|";
    }
    if (f & VK_VIDEO_ENCODE_H265_CAPABILITY_CU_QP_DIFF_WRAPAROUND_BIT_KHR) {
        str += "CU_QP_DIFF_WRAPAROUND|";
    }
    return str;
}

String On_Str_VkVideoEncodeH265StdFlagsKHR([[maybe_unused]] VkVideoEncodeH265StdFlagsKHR f) {
    String str = "|";
...
String On_Str_VkVideoEncodeH265CtbSizeFlagsKHR([[maybe_unused]] VkVideoEncodeH265CtbSizeFlagsKHR f) {
    String str = "|";
...
String On_Str_VkVideoEncodeH265TransformBlockSizeFlagsKHR([[maybe_unused]] VkVideoEncodeH265TransformBlockSizeFlagsKHR f) {
    String str = "|";
...
String On_Str_VkVideoEncodeH265RateControlFlagsKHR([[maybe_unused]] VkVideoEncodeH265RateControlFlagsKHR f) {
    String str = "|";
...
String On_Str_VkVideoDecodeH264PictureLayoutFlagsKHR([[maybe_unused]] VkVideoDecodeH264PictureLayoutFlagsKHR f) {
    String str = "|";
...
String On_Str_VkPerformanceCounterDescriptionFlagsKHR([[maybe_unused]] VkPerformanceCounterDescriptionFlagsKHR f) {
    String str = "|";
...
String On_Str_VkAcquireProfilingLockFlagsKHR([[maybe_unused]] VkAcquireProfilingLockFlagsKHR f) {
    String str = "|";
    return str;
}

String On_Str_VkVideoEncodeFlagsKHR([[maybe_unused]] VkVideoEncodeFlagsKHR f) {
    String str = "|";
    if (f & VK_VIDEO_ENCODE_INTRA_REFRESH_BIT_KHR) {
        str += "INTRA_REFRESH|";
    }
    if (f & VK_VIDEO_ENCODE_WITH_QUANTIZATION_DELTA_MAP_BIT_KHR) {
        str += "WITH_QUANTIZATION_DELTA_MAP|";
    }
    if (f & VK_VIDEO_ENCODE_WITH_EMPHASIS_MAP_BIT_KHR) {
        str += "WITH_EMPHASIS_MAP|";
    }
    return str;
}

String On_Str_VkVideoEncodeCapabilityFlagsKHR([[maybe_unused]] VkVideoEncodeCapabilityFlagsKHR f) {
    String str = "|";
    ...
    if (f & VK_VIDEO_ENCODE_CAPABILITY_QUANTIZATION_DELTA_MAP_BIT_KHR) {
        str += "QUANTIZATION_DELTA_MAP|";
    }
    if (f & VK_VIDEO_ENCODE_CAPABILITY_EMPHASIS_MAP_BIT_KHR) {
        str += "EMPHASIS_MAP|";
    }
    return str;
}

String On_Str_VkVideoEncodeRateControlModeFlagsKHR([[maybe_unused]] VkVideoEncodeRateControlModeFlagsKHR f) {
    String str = "|";
...
String On_Str_VkVideoEncodeFeedbackFlagsKHR([[maybe_unused]] VkVideoEncodeFeedbackFlagsKHR f) {
    String str = "|";
...
String On_Str_VkVideoEncodeUsageFlagsKHR([[maybe_unused]] VkVideoEncodeUsageFlagsKHR f) {
    String str = "|";
...
String On_Str_VkVideoEncodeContentFlagsKHR([[maybe_unused]] VkVideoEncodeContentFlagsKHR f) {
    String str = "|";
...
String On_Str_VkPresentScalingFlagsKHR([[maybe_unused]] VkPresentScalingFlagsKHR f) {
    String str = "|";
    if (f & VK_PRESENT_SCALING_ONE_TO_ONE_BIT_KHR) {
        str += "ONE_TO_ONE|";
    }
    if (f & VK_PRESENT_SCALING_ASPECT_RATIO_STRETCH_BIT_KHR) {
        str += "ASPECT_RATIO_STRETCH|";
    }
    if (f & VK_PRESENT_SCALING_STRETCH_BIT_KHR) {
        str += "STRETCH|";
    }
    return str;
}

String On_Str_VkPresentGravityFlagsKHR([[maybe_unused]] VkPresentGravityFlagsKHR f) {
    String str = "|";
    if (f & VK_PRESENT_GRAVITY_MIN_BIT_KHR) {
        str += "MIN|";
    }
    if (f & VK_PRESENT_GRAVITY_MAX_BIT_KHR) {
        str += "MAX|";
    }
    if (f & VK_PRESENT_GRAVITY_CENTERED_BIT_KHR) {
        str += "CENTERED|";
    }
    return str;
}

String On_Str_VkVideoEncodeAV1CapabilityFlagsKHR([[maybe_unused]] VkVideoEncodeAV1CapabilityFlagsKHR f) {
    String str = "|";
    if (f & VK_VIDEO_ENCODE_AV1_CAPABILITY_PER_RATE_CONTROL_GROUP_MIN_MAX_Q_INDEX_BIT_KHR) {
        str += "VK_VIDEO_ENCODE_AV1_CAPABILITY_PER_RATE_CONTROL_GROUP_MIN_MAX_Q_INDEX|";
    }
    if (f & VK_VIDEO_ENCODE_AV1_CAPABILITY_GENERATE_OBU_EXTENSION_HEADER_BIT_KHR) {
        str += "VK_VIDEO_ENCODE_AV1_CAPABILITY_GENERATE_OBU_EXTENSION_HEADER|";
    }
    if (f & VK_VIDEO_ENCODE_AV1_CAPABILITY_PRIMARY_REFERENCE_CDF_ONLY_BIT_KHR) {
        str += "VK_VIDEO_ENCODE_AV1_CAPABILITY_PRIMARY_REFERENCE_CDF_ONLY|";
    }
    if (f & VK_VIDEO_ENCODE_AV1_CAPABILITY_FRAME_SIZE_OVERRIDE_BIT_KHR) {
        str += "VK_VIDEO_ENCODE_AV1_CAPABILITY_FRAME_SIZE_OVERRIDE|";
    }
    if (f & VK_VIDEO_ENCODE_AV1_CAPABILITY_MOTION_VECTOR_SCALING_BIT_KHR) {
        str += "VK_VIDEO_ENCODE_AV1_CAPABILITY_MOTION_VECTOR_SCALING|";
    }
    if (f & VK_VIDEO_ENCODE_AV1_CAPABILITY_COMPOUND_PREDICTION_INTRA_REFRESH_BIT_KHR) {
        str += "VK_VIDEO_ENCODE_AV1_CAPABILITY_COMPOUND_PREDICTION_INTRA_REFRESH|";
    }
    return str;
}

String On_Str_VkVideoEncodeAV1StdFlagsKHR([[maybe_unused]] VkVideoEncodeAV1StdFlagsKHR f) {
    String str = "|";
    if (f & VK_VIDEO_ENCODE_AV1_STD_UNIFORM_TILE_SPACING_FLAG_SET_BIT_KHR) {
        str += "VK_VIDEO_ENCODE_AV1_STD_UNIFORM_TILE_SPACING_FLAG_SET|";
    }
    if (f & VK_VIDEO_ENCODE_AV1_STD_SKIP_MODE_PRESENT_UNSET_BIT_KHR) {
        str += "VK_VIDEO_ENCODE_AV1_STD_SKIP_MODE_PRESENT_UNSET|";
    }
    if (f & VK_VIDEO_ENCODE_AV1_STD_PRIMARY_REF_FRAME_BIT_KHR) {
        str += "VK_VIDEO_ENCODE_AV1_STD_PRIMARY_REF_FRAME|";
    }
    if (f & VK_VIDEO_ENCODE_AV1_STD_DELTA_Q_BIT_KHR) {
        str += "VK_VIDEO_ENCODE_AV1_STD_DELTA_Q|";
    }
    return str;
}

String On_Str_VkVideoEncodeAV1SuperblockSizeFlagsKHR([[maybe_unused]] VkVideoEncodeAV1SuperblockSizeFlagsKHR f) {
    String str = "|";
    if (f & VK_VIDEO_ENCODE_AV1_SUPERBLOCK_SIZE_64_BIT_KHR) {
        str += "VK_VIDEO_ENCODE_AV1_SUPERBLOCK_SIZE_64|";
    }
    if (f & VK_VIDEO_ENCODE_AV1_SUPERBLOCK_SIZE_128_BIT_KHR) {
        str += "VK_VIDEO_ENCODE_AV1_SUPERBLOCK_SIZE_128|";
    }
    return str;
}

String On_Str_VkVideoEncodeAV1RateControlFlagsKHR([[maybe_unused]] VkVideoEncodeAV1RateControlFlagsKHR f) {
    String str = "|";
    if (f & VK_VIDEO_ENCODE_AV1_RATE_CONTROL_REGULAR_GOP_BIT_KHR) {
        str += "VK_VIDEO_ENCODE_AV1_RATE_CONTROL_REGULAR_GOP|";
    }
    if (f & VK_VIDEO_ENCODE_AV1_RATE_CONTROL_TEMPORAL_LAYER_PATTERN_DYADIC_BIT_KHR) {
        str += "VK_VIDEO_ENCODE_AV1_RATE_CONTROL_TEMPORAL_LAYER_PATTERN_DYADIC|";
    }
    if (f & VK_VIDEO_ENCODE_AV1_RATE_CONTROL_REFERENCE_PATTERN_FLAT_BIT_KHR) {
        str += "VK_VIDEO_ENCODE_AV1_RATE_CONTROL_REFERENCE_PATTERN_FLAT|";
    }
    if (f & VK_VIDEO_ENCODE_AV1_RATE_CONTROL_REFERENCE_PATTERN_DYADIC_BIT_KHR) {
        str += "VK_VIDEO_ENCODE_AV1_RATE_CONTROL_REFERENCE_PATTERN_DYADIC|";
    }
    return str;
}

String On_Str_VkVideoEncodeIntraRefreshModeFlagsKHR([[maybe_unused]] VkVideoEncodeIntraRefreshModeFlagsKHR f) {
    String str = "|";
    if (f & VK_VIDEO_ENCODE_INTRA_REFRESH_MODE_NONE_KHR) {
        str += "NONE_KHR|";
    }
    if (f & VK_VIDEO_ENCODE_INTRA_REFRESH_MODE_PER_PICTURE_PARTITION_BIT_KHR) {
        str += "PER_PICTURE_PARTITION|";
    }
    if (f & VK_VIDEO_ENCODE_INTRA_REFRESH_MODE_BLOCK_BASED_BIT_KHR) {
        str += "BLOCK_BASED|";
    }
    if (f & VK_VIDEO_ENCODE_INTRA_REFRESH_MODE_BLOCK_ROW_BASED_BIT_KHR) {
        str += "BLOCK_ROW_BASED|";
    }
    if (f & VK_VIDEO_ENCODE_INTRA_REFRESH_MODE_BLOCK_COLUMN_BASED_BIT_KHR) {
        str += "BLOCK_COLUMN_BASED|";
    }
    return str;
}

String On_Str_VkAccessFlags3KHR([[maybe_unused]] VkAccessFlags3KHR f) {
    String str = "|";
    if (f & VK_ACCESS_3_NONE_KHR) {
        str += "VK_ACCESS_3_NONE_KHR|";
    }
    return str;
}

String On_Str_VkDebugReportFlagsEXT([[maybe_unused]] VkDebugReportFlagsEXT f) {
    String str = "|";
...
String On_Str_VkExternalMemoryHandleTypeFlagsNV([[maybe_unused]] VkExternalMemoryHandleTypeFlagsNV f) {
    String str = "|";
...
String On_Str_VkExternalMemoryFeatureFlagsNV([[maybe_unused]] VkExternalMemoryFeatureFlagsNV f) {
    String str = "|";
...
String On_Str_VkConditionalRenderingFlagsEXT([[maybe_unused]] VkConditionalRenderingFlagsEXT f) {
    String str = "|";
...
String On_Str_VkSurfaceCounterFlagsEXT([[maybe_unused]] VkSurfaceCounterFlagsEXT f) {
    String str = "|";
...
String On_Str_VkDebugUtilsMessageSeverityFlagsEXT([[maybe_unused]] VkDebugUtilsMessageSeverityFlagsEXT f) {
    String str = "|";
...
String On_Str_VkDebugUtilsMessageTypeFlagsEXT([[maybe_unused]] VkDebugUtilsMessageTypeFlagsEXT f) {
    String str = "|";
...
String On_Str_VkGeometryFlagsKHR([[maybe_unused]] VkGeometryFlagsKHR f) {
    String str = "|";
...
String On_Str_VkGeometryInstanceFlagsKHR([[maybe_unused]] VkGeometryInstanceFlagsKHR f) {
    String str = "|";
    ...
    if (f & VK_GEOMETRY_INSTANCE_FORCE_OPACITY_MICROMAP_2_STATE_BIT_EXT) {
        str += "FORCE_OPACITY_MICROMAP_2_STATE|";
    }
    if (f & VK_GEOMETRY_INSTANCE_DISABLE_OPACITY_MICROMAPS_BIT_EXT) {
        str += "DISABLE_OPACITY_MICROMAPS|";
    }
    return str;
}

String On_Str_VkBuildAccelerationStructureFlagsKHR([[maybe_unused]] VkBuildAccelerationStructureFlagsKHR f) {
    String str = "|";
    ...
    if (f & VK_BUILD_ACCELERATION_STRUCTURE_ALLOW_OPACITY_MICROMAP_UPDATE_BIT_EXT) {
        str += "ALLOW_OPACITY_MICROMAP_UPDATE|";
    }
    if (f & VK_BUILD_ACCELERATION_STRUCTURE_ALLOW_DISABLE_OPACITY_MICROMAPS_BIT_EXT) {
        str += "ALLOW_DISABLE_OPACITY_MICROMAPS|";
    }
    if (f & VK_BUILD_ACCELERATION_STRUCTURE_ALLOW_OPACITY_MICROMAP_DATA_UPDATE_BIT_EXT) {
        str += "ALLOW_OPACITY_MICROMAP_DATA_UPDATE|";
    }
#ifdef VK_ENABLE_BETA_EXTENSIONS
    if (f & VK_BUILD_ACCELERATION_STRUCTURE_ALLOW_DISPLACEMENT_MICROMAP_UPDATE_BIT_NV) {
        str += "ALLOW_DISPLACEMENT_MICROMAP_UPDATE|";
    }
#endif // VK_ENABLE_BETA_EXTENSIONS
    if (f & VK_BUILD_ACCELERATION_STRUCTURE_ALLOW_DATA_ACCESS_BIT_KHR) {
        str += "ALLOW_DATA_ACCESS|";
    }
    return str;
}

String On_Str_VkPipelineCompilerControlFlagsAMD([[maybe_unused]] VkPipelineCompilerControlFlagsAMD f) {
    String str = "|";
    return str;
}

String On_Str_VkShaderCorePropertiesFlagsAMD([[maybe_unused]] VkShaderCorePropertiesFlagsAMD f) {
    String str = "|";
    return str;
}

String On_Str_VkIndirectStateFlagsNV([[maybe_unused]] VkIndirectStateFlagsNV f) {
    String str = "|";
...
String On_Str_VkIndirectCommandsLayoutUsageFlagsNV([[maybe_unused]] VkIndirectCommandsLayoutUsageFlagsNV f) {
    String str = "|";
...
String On_Str_VkDeviceDiagnosticsConfigFlagsNV([[maybe_unused]] VkDeviceDiagnosticsConfigFlagsNV f) {
    String str = "|";
...
String On_Str_VkTileShadingRenderPassFlagsQCOM([[maybe_unused]] VkTileShadingRenderPassFlagsQCOM f) {
    String str = "|";
    if (f & VK_TILE_SHADING_RENDER_PASS_ENABLE_BIT_QCOM) {
        str += "VK_TILE_SHADING_RENDER_PASS_ENABLE|";
    }
    if (f & VK_TILE_SHADING_RENDER_PASS_PER_TILE_EXECUTION_BIT_QCOM) {
        str += "VK_TILE_SHADING_RENDER_PASS_PER_TILE_EXECUTION|";
    }
    return str;
}

#ifdef VK_USE_PLATFORM_METAL_EXT
String On_Str_VkExportMetalObjectTypeFlagsEXT([[maybe_unused]] VkExportMetalObjectTypeFlagsEXT f) {
    String str = "|";
...
String On_Str_VkGraphicsPipelineLibraryFlagsEXT([[maybe_unused]] VkGraphicsPipelineLibraryFlagsEXT f) {
    String str = "|";
...
String On_Str_VkImageCompressionFlagsEXT([[maybe_unused]] VkImageCompressionFlagsEXT f) {
    String str = "|";
...
String On_Str_VkImageCompressionFixedRateFlagsEXT([[maybe_unused]] VkImageCompressionFixedRateFlagsEXT f) {
    String str = "|";
...
String On_Str_VkDeviceAddressBindingFlagsEXT([[maybe_unused]] VkDeviceAddressBindingFlagsEXT f) {
    String str = "|";
...
String On_Str_VkImageConstraintsInfoFlagsFUCHSIA([[maybe_unused]] VkImageConstraintsInfoFlagsFUCHSIA f) {
    String str = "|";
...
String On_Str_VkFrameBoundaryFlagsEXT([[maybe_unused]] VkFrameBoundaryFlagsEXT f) {
    String str = "|";
...
String On_Str_VkBuildMicromapFlagsEXT([[maybe_unused]] VkBuildMicromapFlagsEXT f) {
    String str = "|";
...
String On_Str_VkMicromapCreateFlagsEXT([[maybe_unused]] VkMicromapCreateFlagsEXT f) {
    String str = "|";
...
String On_Str_VkPhysicalDeviceSchedulingControlsFlagsARM([[maybe_unused]] VkPhysicalDeviceSchedulingControlsFlagsARM f) {
    String str = "|";
...
String On_Str_VkMemoryDecompressionMethodFlagsNV([[maybe_unused]] VkMemoryDecompressionMethodFlagsNV f) {
    String str = "|";
...
String On_Str_VkTensorCreateFlagsARM([[maybe_unused]] VkTensorCreateFlagsARM f) {
    String str = "|";
    if (f & VK_TENSOR_CREATE_MUTABLE_FORMAT_BIT_ARM) {
        str += "VK_TENSOR_CREATE_MUTABLE_FORMAT_BIT_ARM|";
    }
    if (f & VK_TENSOR_CREATE_PROTECTED_BIT_ARM) {
        str += "VK_TENSOR_CREATE_PROTECTED_BIT_ARM|";
    }
    if (f & VK_TENSOR_CREATE_DESCRIPTOR_BUFFER_CAPTURE_REPLAY_BIT_ARM) {
        str += "VK_TENSOR_CREATE_DESCRIPTOR_BUFFER_CAPTURE_REPLAY_BIT_ARM|";
    }
    return str;
}

String On_Str_VkTensorViewCreateFlagsARM([[maybe_unused]] VkTensorViewCreateFlagsARM f) {
    String str = "|";
    if (f & VK_TENSOR_VIEW_CREATE_DESCRIPTOR_BUFFER_CAPTURE_REPLAY_BIT_ARM) {
        str += "VK_TENSOR_VIEW_CREATE_DESCRIPTOR_BUFFER_CAPTURE_REPLAY_BIT_ARM|";
    }
    return str;
}

String On_Str_VkTensorUsageFlagsARM([[maybe_unused]] VkTensorUsageFlagsARM f) {
    String str = "|";
    if (f & VK_TENSOR_USAGE_SHADER_BIT_ARM) {
        str += "VK_TENSOR_USAGE_SHADER_BIT_ARM|";
    }
    if (f & VK_TENSOR_USAGE_TRANSFER_SRC_BIT_ARM) {
        str += "VK_TENSOR_USAGE_TRANSFER_SRC_BIT_ARM|";
    }
    if (f & VK_TENSOR_USAGE_TRANSFER_DST_BIT_ARM) {
        str += "VK_TENSOR_USAGE_TRANSFER_DST_BIT_ARM|";
    }
    if (f & VK_TENSOR_USAGE_IMAGE_ALIASING_BIT_ARM) {
        str += "VK_TENSOR_USAGE_IMAGE_ALIASING_BIT_ARM|";
    }
    if (f & VK_TENSOR_USAGE_DATA_GRAPH_BIT_ARM) {
        str += "VK_TENSOR_USAGE_DATA_GRAPH_BIT_ARM|";
    }
    return str;
}

String On_Str_VkOpticalFlowGridSizeFlagsNV([[maybe_unused]] VkOpticalFlowGridSizeFlagsNV f) {
    String str = "|";
...
String On_Str_VkOpticalFlowUsageFlagsNV([[maybe_unused]] VkOpticalFlowUsageFlagsNV f) {
    String str = "|";
...
String On_Str_VkOpticalFlowSessionCreateFlagsNV([[maybe_unused]] VkOpticalFlowSessionCreateFlagsNV f) {
    String str = "|";
...
String On_Str_VkOpticalFlowExecuteFlagsNV([[maybe_unused]] VkOpticalFlowExecuteFlagsNV f) {
    String str = "|";
...
String On_Str_VkShaderCreateFlagsEXT([[maybe_unused]] VkShaderCreateFlagsEXT f) {
    String str = "|";
    ...
    if (f & VK_SHADER_CREATE_INDIRECT_BINDABLE_BIT_EXT) {
        str += "INDIRECT_BINDABLE|";
    }
    return str;
}

String On_Str_VkDataGraphPipelineSessionCreateFlagsARM([[maybe_unused]] VkDataGraphPipelineSessionCreateFlagsARM f) {
    String str = "|";
    if (f & VK_DATA_GRAPH_PIPELINE_SESSION_CREATE_PROTECTED_BIT_ARM) {
        str += "VK_DATA_GRAPH_PIPELINE_SESSION_CREATE_PROTECTED_BIT_ARM|";
    }
    return str;
}

String On_Str_VkDataGraphPipelineDispatchFlagsARM([[maybe_unused]] VkDataGraphPipelineDispatchFlagsARM f) {
    String str = "|";
    return str;
}

String On_Str_VkClusterAccelerationStructureAddressResolutionFlagsNV(
    [[maybe_unused]] VkClusterAccelerationStructureAddressResolutionFlagsNV f) {
    String str = "|";
    if (f & VK_CLUSTER_ACCELERATION_STRUCTURE_ADDRESS_RESOLUTION_NONE_NV) {
        str += "NONE_NV|";
    }
    if (f & VK_CLUSTER_ACCELERATION_STRUCTURE_ADDRESS_RESOLUTION_INDIRECTED_DST_IMPLICIT_DATA_BIT_NV) {
        str += "INDIRECTED_DST_IMPLICIT_DATA|";
    }
    if (f & VK_CLUSTER_ACCELERATION_STRUCTURE_ADDRESS_RESOLUTION_INDIRECTED_SCRATCH_DATA_BIT_NV) {
        str += "INDIRECTED_SCRATCH_DATA|";
    }
    if (f & VK_CLUSTER_ACCELERATION_STRUCTURE_ADDRESS_RESOLUTION_INDIRECTED_DST_ADDRESS_ARRAY_BIT_NV) {
        str += "INDIRECTED_DST_ADDRESS_ARRAY|";
    }
    if (f & VK_CLUSTER_ACCELERATION_STRUCTURE_ADDRESS_RESOLUTION_INDIRECTED_DST_SIZES_ARRAY_BIT_NV) {
        str += "INDIRECTED_DST_SIZES_ARRAY|";
    }
    if (f & VK_CLUSTER_ACCELERATION_STRUCTURE_ADDRESS_RESOLUTION_INDIRECTED_SRC_INFOS_ARRAY_BIT_NV) {
        str += "INDIRECTED_SRC_INFOS_ARRAY|";
    }
    if (f & VK_CLUSTER_ACCELERATION_STRUCTURE_ADDRESS_RESOLUTION_INDIRECTED_SRC_INFOS_COUNT_BIT_NV) {
        str += "INDIRECTED_SRC_INFOS_COUNT|";
    }
    return str;
}

String On_Str_VkClusterAccelerationStructureClusterFlagsNV([[maybe_unused]] VkClusterAccelerationStructureClusterFlagsNV f) {
    String str = "|";
    if (f & VK_CLUSTER_ACCELERATION_STRUCTURE_CLUSTER_ALLOW_DISABLE_OPACITY_MICROMAPS_NV) {
        str += "ALLOW_DISABLE_OPACITY_MICROMAPS_NV|";
    }
    return str;
}

String On_Str_VkClusterAccelerationStructureGeometryFlagsNV([[maybe_unused]] VkClusterAccelerationStructureGeometryFlagsNV f) {
    String str = "|";
    if (f & VK_CLUSTER_ACCELERATION_STRUCTURE_GEOMETRY_CULL_DISABLE_BIT_NV) {
        str += "CULL_DISABLE|";
    }
    if (f & VK_CLUSTER_ACCELERATION_STRUCTURE_GEOMETRY_NO_DUPLICATE_ANYHIT_INVOCATION_BIT_NV) {
        str += "NO_DUPLICATE_ANYHIT_INVOCATION|";
    }
    if (f & VK_CLUSTER_ACCELERATION_STRUCTURE_GEOMETRY_OPAQUE_BIT_NV) {
        str += "OPAQUE|";
    }
    return str;
}

String On_Str_VkClusterAccelerationStructureIndexFormatFlagsNV(
    [[maybe_unused]] VkClusterAccelerationStructureIndexFormatFlagsNV f) {
    String str = "|";
    if (f & VK_CLUSTER_ACCELERATION_STRUCTURE_INDEX_FORMAT_8BIT_NV) {
        str += "8BIT_NV|";
    }
    if (f & VK_CLUSTER_ACCELERATION_STRUCTURE_INDEX_FORMAT_16BIT_NV) {
        str += "16BIT_NV|";
    }
    if (f & VK_CLUSTER_ACCELERATION_STRUCTURE_INDEX_FORMAT_32BIT_NV) {
        str += "32BIT_NV|";
    }
    return str;
}

String On_Str_VkPartitionedAccelerationStructureInstanceFlagsNV(
    [[maybe_unused]] VkPartitionedAccelerationStructureInstanceFlagsNV f) {
    String str = "|";
    if (f & VK_PARTITIONED_ACCELERATION_STRUCTURE_INSTANCE_FLAG_TRIANGLE_FACING_CULL_DISABLE_BIT_NV) {
        str += "FLAG_TRIANGLE_FACING_CULL_DISABLE|";
    }
    if (f & VK_PARTITIONED_ACCELERATION_STRUCTURE_INSTANCE_FLAG_TRIANGLE_FLIP_FACING_BIT_NV) {
        str += "FLAG_TRIANGLE_FLIP_FACING|";
    }
    if (f & VK_PARTITIONED_ACCELERATION_STRUCTURE_INSTANCE_FLAG_FORCE_OPAQUE_BIT_NV) {
        str += "FLAG_FORCE_OPAQUE|";
    }
    if (f & VK_PARTITIONED_ACCELERATION_STRUCTURE_INSTANCE_FLAG_FORCE_NO_OPAQUE_BIT_NV) {
        str += "FLAG_FORCE_NO_OPAQUE|";
    }
    if (f & VK_PARTITIONED_ACCELERATION_STRUCTURE_INSTANCE_FLAG_ENABLE_EXPLICIT_BOUNDING_BOX_NV) {
        str += "FLAG_ENABLE_EXPLICIT_BOUNDING_BOX_NV|";
    }
    return str;
}

String On_Str_VkIndirectCommandsInputModeFlagsEXT([[maybe_unused]] VkIndirectCommandsInputModeFlagsEXT f) {
    String str = "|";
    if (f & VK_INDIRECT_COMMANDS_INPUT_MODE_VULKAN_INDEX_BUFFER_EXT) {
        str += "VULKAN_INDEX_BUFFER_EXT|";
    }
    if (f & VK_INDIRECT_COMMANDS_INPUT_MODE_DXGI_INDEX_BUFFER_EXT) {
        str += "DXGI_INDEX_BUFFER_EXT|";
    }
    return str;
}

String On_Str_VkIndirectCommandsLayoutUsageFlagsEXT([[maybe_unused]] VkIndirectCommandsLayoutUsageFlagsEXT f) {
    String str = "|";
    if (f & VK_INDIRECT_COMMANDS_LAYOUT_USAGE_EXPLICIT_PREPROCESS_BIT_EXT) {
        str += "EXPLICIT_PREPROCESS|";
    }
    if (f & VK_INDIRECT_COMMANDS_LAYOUT_USAGE_UNORDERED_SEQUENCES_BIT_EXT) {
        str += "UNORDERED_SEQUENCES|";
    }
    return str;
}

String On_Str_VkAccelerationStructureCreateFlagsKHR([[maybe_unused]] VkAccelerationStructureCreateFlagsKHR f) {
    String str = "|";
